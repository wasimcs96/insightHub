...
{   
    ...
    {
        return $this->belongsTo(MasterJob::class, 'master_id');
    }
    ...
    {
        return $this->hasMany(JobCriticalFunction::class, 'job_id');
    }
    ...
    {
        return $this->belongsToMany(MasterTechnicalSkill::class,'job_technical_skills','job_id')->withPivot('id','level');
    }
    ...
    public function superior() {
        return $this->belongsTo(MasterJob::class, 'superior_id');
    }

    public function subordinates_s() {
        return $this->hasMany(MasterJob::class, 'superior_id');
    }
    ...
    public function subordinateJobs() {
        return $this->belongsToMany(MasterJob::class, 'job_subordinates', 'job_id', 'subordinate_id');
    }

    public function superiorJobs() {
        return $this->belongsToMany(MasterJob::class, 'job_subordinates', 'subordinate_id', 'job_id');
    }
    ...
    {
        return $this->hasMany(MasterJob::class, 'superior_id')->with('children'); // recursion
    }
