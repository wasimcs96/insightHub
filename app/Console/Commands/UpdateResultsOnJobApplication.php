...
class UpdateResultsOnJobApplication extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'job-opening:update-result-on-job-application {job_id} {user_id}';
     ...
     * @var string
     */
    protected $description = 'Update reports based on a specific job id and a user ID';
    ...
    {
        // Retrieve arguments
        $position_id = $this->argument('job_id');
        ...
        \App\Jobs\UpdateResultsOnJobApplication::dispatch($user_id, $position_id);
