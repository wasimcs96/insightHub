...
class AdvancedComparisonTmController extends Controller
{
    /**
     ...
     */
     ...
     public function tmAdvancedComparison (Request $request) {
        $responseData = [];
        ...
        // dd($responseData);
        return view('admin.advanced-comparison.talent-management.filter', $responseData);
    }
    ...
    public function report(Request $request) {
        ...
        // dd($responseData);
        return view('admin.advanced-comparison.talent-management.report', ['responseData' => $responseData]);
    }
}
