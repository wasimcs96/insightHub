...
return [
   ...
   'routes' => [
    [
        'match' => [
            'prefixes' => ['rest/v1'], // match only routes starting with rest/v1
            'domains' => ['*'],
        ],
        'include' => [
            'rest/v1/divisions',
            'rest/v1/business-units',
            'rest/v1/departments',
            'rest/v1/employees',
            'rest/v1/employees/*',
            'rest/v1/jd/*',
            'rest/v1/company-details',
            'rest/v1/employees/*/psychometric-results',
            'rest/v1/organization-chart',
            'rest/v1/technical-skill/details/*',
            'rest/v1/soft-skill/details/*',
            'rest/v1/sectors',
            'rest/v1/jobs'
        ],
        'exclude' => [],
    ...
    'in' => 'header',
    'name' => 'x-api-key',
    'use_value' => env('X_API_KEY', 'your-default-api-key'),
