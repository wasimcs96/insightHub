        ...
        <div class="d-flex flex-lg-row-fluid">
            ...
            <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100"> 
                ...
                {{-- <a href="#" class="d-flex justify-content-center mb-5 mb-lg-10">
                    <img alt="Logo" src="{{ asset('media/eei_logo_new.png')}}" class="h-50px h-lg-70px" />
                </a> --}}
                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        ...
                        <form class="form w-100 mb-13" novalidate="novalidate"
                            data-kt-redirect-url="{{ route('password.otp') }}" action="{{ route('password.otp') }}" method="POST" id="kt_sing_in_two_factor_form">
                            @csrf
                            <!--begin::Icon-->
                            ...
                            <div class="text-center mb-10">
                                ...
                                <div class="text-muted fw-semibold fs-5 mb-5">
                                    Input your email to get an OTP
                                </div>
                                <!--end::Sub-title-->
                                <!--begin::Mobile no-->
                            ...
                            <div class="mb-10">      
                                ...
                                <div class="fv-row mb-8">
                                        ...
                                        <!--end::Label-->
                                    <!--begin::Email-->
                                    <input type="text" placeholder="Email" name="email" value="{{ auth()->user()->email ?? old('email') }}" autocomplete="email" class="form-control bg-transparent"/> 
                                        @error('email')
