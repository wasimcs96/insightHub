...
<div class="filter-buttons d-flex align-items-center mb-14 justify-content-between" data-tab="{{ $tabType }}">
    <div class="filter-container1">
            ...
            <div class="dropdown-menu mt-4" style="width: 210px; max-height: 300px; overflow-y: auto;">
                @foreach($positionsByLevel as $positionLevel)
                    <div class="d-flex gap-3 align-items-center custom-check-input">
                        <input class="interview-option" type="radio" name="{{ $filterPrefix }}PositionLevelFilter"
                            value="{{ $positionLevel['level'] }}" data-target="{{ $filterPrefix }}PositionLevel">
        ...
        <div class="dropdown">
            <button class="filter-btn" type="button" id="{{ $filterPrefix }}JobPosition" data-bs-toggle="dropdown"
            ...
            <div class="dropdown-menu mt-4" style="width: 210px; max-height: 300px; overflow-y: auto;">
                ...
                @endforeach
                <div class="d-flex justify-content-end gap-4 align-items-center button-div">
                    <button class="resetBtn border-0" data-target="{{ $filterPrefix }}JobPosition">Cancel</button>
                    <button class="filter border-0">Filter</button>
                </div>
            </div>
        </div>
