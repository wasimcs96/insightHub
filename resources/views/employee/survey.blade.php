                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                           ...
                           @php $surveyResult = App\Models\SurveyResult::where('user_id',auth()->user()->id)->where('survey_id',$value->id)->count();@endphp
                            ...
                            <td class="text-center">
                                ...
                                @if (!$surveyResult) <!-- Only show button if not completed -->
                                <a href="{{ route('employee.survey.start', $value->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
