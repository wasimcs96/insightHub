                            ...
                            @else
                                <form
                                        ...
                                        <fieldset class="question-step question-step-{{ $key + 1 }}">
                                            ...
                                            <div class="">
                                                ...
                                                <div class="question-multi-answers mt-35">
                                                    ...
                                                    @for ($i = 1; $i <= 4; $i++)
                                                        <div
                                                            class="align-content-center answer-item border border-gray200 d-flex flex-nowrap mb-2 rounded-sm text-gray">
                                    ...
                                    <div class="d-flex align-items-center mt-30 justify-content-end mt-4">
                                        <button type="button" class="previous btn btn-sm btn-primary me-10">Previous
                                            Question</button>
                                        <button type="button" class="next btn btn-sm btn-primary mr-auto me-10">Next
                                            Question</button>
                                        <button type="submit" class="finish btn btn-sm btn-danger me-10">Finish</button>
                                    </div>
                                </form>
                            @endif
