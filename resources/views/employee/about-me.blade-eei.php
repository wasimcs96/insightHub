                        ...
                        <div class="card-text h-full space-y-4">
                            <form action="{{ route('employee.about.me.store') }}" id="job_description_form" method="POST">
                                ...
                                <div class="card rounded-20px">
                                    ...
                                    <h3 class="mb-4 me-5 ms-5 mt-4 mt-6 pb-3 text-danger"
                                        style="border-bottom:2px solid black;">Personal Details</h3>
                                    {{-- </header> --}}
                                    ...
                                    <div class="card-body flex flex-col p-6">
                                        <div class="row mb-5">
                                            <div class="input-area col-xl-3">
                                                ...
                                                <input id="suffix" type="text" class="form-control" name="suffix"
                                                    placeholder="Enter Suffix ex:Sr."
                                                    value="{{ auth()->user()->suffix ?? '' }}"hc b>
                                                @error('suffix')
                                            ...
                                            <div class="input-area col-xl-3">
                                                ...
                                                <input id="last_name" type="text" class="form-control" disabled
                                            ...
                                            <div class="input-area col-xl-6">
                                                ...
                                                <select id="marital_status" class="form-control" name="marital_status">
                                                    ...
                                                    @foreach (config('constants.MARITAL_STATUSES') as $key => $ms)
                                                        <option value="{{ $key }}"
                                                            @if (auth()->user()->marital_status == $key) Selected @endif>
                                                            {{ $ms }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row mb-5 ">
                                            <div class="input-area col-xl-3">
                                                <label for="select" class="form-label">Select Nationality</label>
                                                ...
                                                <select id="country_id" class="form-control" name="country_id" required>
                                                    ...
                                                    @foreach ($master_country as $mc)
                                                        <option value="{{ $mc->id }}"
                                                            {{ auth()->user()->country_id == $mc->id ? 'selected' : '' }}>
                                                            {{ $mc->name ?? '' }}</option>
                                                    @endforeach
                                                </select>
                                                @error('country_id')
                                            ...
                                            <div class="input-area col-xl-3">
                                                ...
                                                <input id="passport_no" type="text" class="form-control"
                                                    name="passport_no" placeholder="Passport No"
                                                    value="{{ auth()->user()->passport_no ?? '' }}">
                                                @error('passport_no')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="row mb-5 pt-2">
                                            <div class="input-area col-xl-3">
                                                <label for="home_address" class="form-label">House/Building Number and
                                                    Street
                                                    Name</label>
                                                <input id="home_address" type="text" class="form-control"
                                            ...
                                            <div class="input-area col-xl-3">
                                                ...
                                                <select id="sub_division" class="form-control select2-ajax"
                                                    name="barangay_id" data-control="select2" data-hide-search="false">
                                        ...
                                        <div class="row mb-5 pt-2">
                                            <div class="input-area col-xl-3">
                                                <label for="mailing_address" class="form-label">House/Building Number and
                                                    Street
                                                    Name</label>
                                            ...
                                            <div class="input-area col-xl-3">
                                                <label for="mailing_sub_division"
                                                    class="form-label">Barangay/Subdivision</label>
                                                <select id="mailing_sub_division" class="form-control select2-ajax"
                                                    name="mailing_barangay_id" data-control="select2"
                                            ...
                                            <div class="input-area col-xl-2">
                                                ...
                                                <select id="mailing_province" class="form-control"
                                                    name="mailing_province_id" data-control="select2"
                                                    data-hide-search="false">
                                                    <option value="">Select Province</option>
                                ...
                                <div class="card mt-11 rounded-20px">
                                    {{-- <header class=""> --}}

                                    <h3 class="mb-4 me-5 ms-5 mt-4 mt-6 pb-3 text-danger"
                                        style="border-bottom:2px solid black;">Education Experience</h3>
                                    {{-- </header> --}}

                                    <div class="card-body flex flex-col p-6">
                                        <h5 class="mt-5 mb-2">Skills and Certifications <br> <span
                                                class=" fs-6 fw-medium text-danger"> After each entry press "Enter" to
                                                create new
                                                input</span></h5>
                                        <div class="row ">
                                            ...
                                            <div class="input-area col-lg-4">
                                                ...
                                                <div id="message" style="display: none; color: red;">You can only select
                                                    up to 5
                                                    options.</div>
                                            </div>
                                        ...
                                        <div class="row mb-5 pb-4">
                                            ...
                                            <div class="input-area col-xl-3">
                                                <label for="select" class="form-label">Select Higher Learning
                                                    Institution*</label>
                                            ...
                                            <div class="input-area col-xl-3">
                                                <label for="select" class="form-label">Select Course/Program*</label>
                                                <select id="scope_of_study" class="form-control"
                                                    name="education_program_id">
                                                    @foreach ($edu_program as $scope_of_study)
                                                        <option value="{{ $scope_of_study->id }}"
                                                            class="dark:bg-slate-700"
                                            ...
                                            <div class="input-area col-xl-3">
                                                <label for="graduate_year" class="form-label">Year of Graduation*</label>
                                        ...
                                        <div class="row mb-5 pb-4">
                                            ...
                                            <div class="input-area col-xl-4">
                                                ...
                                                <input id="year_of_experience_in_it_sector" type="number"
                                                    class="form-control" name="year_of_experience_in_it_sector"
                                            ...
                                            <div class="input-area col-xl-4">
                                                ...
                                                <select id="sector" class="form-control" name="sector_id">
                                                    <option value="" class="dark:bg-slate-700">Select Sector
                                                    </option>
                                            ...
                                            @if (auth()->user()->employments()->count() > 0)
                                                @foreach (auth()->user()->employments as $employment)
                                                    <div class="row justify-content-end work_Exp">
                                                        <div class="input-area col-lg-6">
                                                            <label for="job_title_{{ $loop->index }}"
                                                        ...
                                                        <div class="input-area col-lg-2">
                                                            <label for="start_date_{{ $loop->index }}"
                                                        ...
                                                        <div class="input-area col-lg-2">
                                                            <label for="end_date_{{ $loop->index }}"
                                                        ...
                                                        @if ($loop->index < 1)
                                                            <div class="checkbox-area col-lg-10">
                                                                <label for="current_workplace_{{ $loop->index }}"
                                                                    class="form-label">I am currently working in this role</label>
                                                                ...
                                                                <div class="checkbox-area mt-2">
                                                                    <label for="current_workplace_{{ $loop->index }}"
                                                                        ...
                                                                        <label for="current_workplace_{{ $loop->index }}"
                                                                            class="text-slate-500 dark:text-slate-400 text-sm leading-6">I am currently working in this role</label>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="row justify-content-end work_Exp">
                                                    ...
                                                    <div class="input-area col-lg-6">
                                                        ...
                                                        <input id="company_name" type="text" class="form-control"
                                                            name="employments[0][company_name]"
                                                            placeholder="Company Name">
                                                    </div>
                                                    <div class="input-area col-lg-2">
                                                    ...
                                                    <div class="checkbox-area col-lg-10">
                                                        <label for="current_workplace_0" class="form-label">I am currently working in this role</label>
                                                        ...
                                                        <div class="checkbox-area mt-2">
                                                            <label for="current_workplace_0"
                                                                class="inline-flex items-center cursor-pointer">
                                                                <input type="checkbox" id="current_workplace_0"
                                                                    type="checkbox" class="hidden"
                                                                    name="employments[0][current_workplace]"
                                                                    name="checkbox">
                                                                <span
                                                                    class="h-4 w-4 border flex-none border-slate-100 dark:border-slate-800 rounded inline-flex ltr:mr-3 rtl:ml-3 relative transition-all duration-150 bg-slate-100 dark:bg-slate-900">
                                                                    <img src="{{ asset('assets/images/icon/ck-white.svg') }}"
                                                ...
                                                <div class="accordion-item">
                                                        ...
                                                        <button class="accordion-button fs-4 fw-semibold" type="button"
                                                            ...
                                                            <div class="form-check mb-3 col-lg-12">
                                                                ...
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="consent_data" id="consent_data">
                                                    ...
                                                    <div id="kt_accordion_1_body_1"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <p>By accessing and using the services provided by CXS Analytics
                                                                you acknowledge that you have read, understood, and agree to
                                                                be bound by these terms and any additional guidelines,
                                                                policies, or rules applicable to specific services.</p>
                                                            <p class="fw-bold"> 2. Data Privacy</p>
                                                            We are committed to protecting your personal data in accordance
                                                            with the Data Privacy Act of 2012 (Republic Act No. 10173). Your
                                                            data will be collected, used, and processed solely for the
                                                            purpose of providing our services and improving user experience.
                                                            For more information, please refer to our Privacy Policy.
                                                            <p class="fw-bold"> 3. User Responsibilities</p>
                                                            <p> You agree to use our platform for lawful purposes only. You
                                                                must not:
                                                                Engage in any activity that disrupts or interferes with our
                                                                services or network.
                                                                Use our platform to store, transmit, or distribute any
                                                                malicious software or illegal content.
                                                                Violate any applicable local, national, or international
                                                                law.</p>
                                                            <p class="fw-bold"> 4. Intellectual Property</p>
                                                            <p> All content, trademarks, logos, and intellectual property on
                                                                our platform are owned by CXS Analytics or our licensors.
                                                                You are granted a limited, non-exclusive license to use the
                                                                platform in accordance with these terms.</p>
                                                            <p class="fw-bold"> 5. Limitation of Liability</p>
                                                            <p> To the maximum extent permitted by law, CXS Analytics shall
                                                            ...
                                                            <p>We reserve the right to modify these terms at any time. We
                                                                will notify you of any changes by posting the new terms on
                                                                our platform. Your continued use of the platform following
                                                                the posting of changes constitutes your acceptance of the
                                                                new terms.</p>
                                                            <p class="fw-bold"> 8. Contact Information</p>
                                                            <p>If you have any questions or concerns about these terms,
                                                                please contact us at: CXS Analytics, info@cxsanalytics.com
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
