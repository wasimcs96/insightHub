...
<div class="modal-body text-center">
    ...
    <p class="text-center" style="color: #071437; margin-bottom: 13px;">
      You are about to remove headcount(s) from the job position: <b style="overflow-wrap: anywhere;">{{ $job_title }}</b>.
    </p>
<p class="text-center" style="color: #071437; margin-bottom: 13px;">
        They will also be removed from the org chart. This action cannot be undone. Are you sure you want to continue?
    </p>
