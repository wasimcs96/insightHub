...
<div class="modal-body text-center">
    ...
    <p class="text-center" style="color: #071437; margin-bottom: 13px;">
     You're about to change the job position title from <b>{{ $old_value }}</b> to <b>{{ $new_value }}</b>.
    </p>
<p class="text-center" style="color: #071437; margin-bottom: 13px;">
        This update will be reflected in the Org Chart once confirmed. Are you sure you want to proceed?
    </p>
</div>
