    ...
    [
        ...
        'sections' => [
            [
                ...
                'enabled' => true,
                'modules' => [
                    [ 'row' => 'Dashboard', 'permissions' => [ 'all' => false, 'view' => true, 'create' => false, 'edit' => false, 'delete' => false ] ],
                    [ 'row' => 'Chatbot', 'permissions' => [ 'all' => true, 'view' => true, 'create' => true, 'edit' => false, 'delete' => false ] ]
                ]
            ],
            [
                'name' => 'Settings',
                'enabled' => true,
                'modules' => [
                    [ 'row' => 'User Management', 'permissions' => [ 'all' => true, 'view' => true, 'create' => true, 'edit' => true, 'delete' => false ] ],
                    [ 'row' => 'Role Management', 'permissions' => [ 'all' => true, 'view' => true, 'create' => true, 'edit' => true, 'delete' => true ] ],
                    [ 'row' => 'General Settings', 'permissions' => [ 'all' => true, 'view' => true, 'create' => true, 'edit' => true, 'delete' => true ] ]
                ]
            ]
        ]
    ],
        ...
        <div id="kt_app_toolbar_container" class="container-xxl app-container d-flex flex-stack">
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>
                    <li class="breadcrumb-item text-muted" id="breadcrumb-last">Create Role</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid p-0">
        <div id="kt_app_content_container" class="container-xxl app-container">
            <div class="page-header my-15 d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="top-heading m-0">Create Role</h4>
                </div>
                                            ...
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="heading{{ $section['name'] }}">
                                                    <button class="accordion-button collapsed" type="button"
                                                        ...
                                                        aria-expanded="true">
                                                        <div class="module-header w-100">
                                                        <span class="fs-5">{{ $section['name'] }}</span>
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input parent-toggle" type="checkbox"
