...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid p-0">
        <div id="kt_app_content_container" class="container-xxl app-container">
            ...
            <form action="{{ route('insighthub.role-management.store') }}" method="POST" id="createRoleForm">
                @csrf
                                                                                    ...
                                                                                    @if($permRow['view'])
                                                                                        <div class="form-check form-switch">
                                                                                            <input class="form-check-input individual-permission" 
                                                                                                   ...
                                                                                                   data-row="{{ $loop->index }}"
                                                                                                   {{ !empty(old('permissions')) ? (in_array($permRow['view']->id, old('permissions', [])) ? 'checked' : '') : 'checked' }}>
                                                                                        </div>
                                                                                    @else
                                                                                    ...
                                                                                    @if($permRow['create'])
                                                                                        <div class="form-check form-switch">
                                                                                            <input class="form-check-input individual-permission" 
                                                                                                   ...
                                                                                                   data-row="{{ $loop->index }}"
                                                                                                   {{ !empty(old('permissions')) ? (in_array($permRow['create']->id, old('permissions', [])) ? 'checked' : '') : 'checked' }}>
                                                                                        </div>
                                                                                    @else
                                                                                        <span class="text-center">-</span>
                                                                                    @endif
                                                                                    ...
                                                                                    @if($permRow['edit'])
                                                                                        <div class="form-check form-switch">
                                                                                            <input class="form-check-input individual-permission" 
                                                                                                   ...
                                                                                                   data-row="{{ $loop->index }}"
                                                                                                   {{ !empty(old('permissions')) ? (in_array($permRow['edit']->id, old('permissions', [])) ? 'checked' : '') : 'checked' }}>
                                                                                        </div>
                                                                                    @else
                                                                                        <span class="text-center">-</span>
                                                                                    @endif
                                                                                    ...
                                                                                    @if($permRow['delete'])
                                                                                        <div class="form-check form-switch">
                                                                                            <input class="form-check-input individual-permission" 
                                                                                                   ...
                                                                                                   data-row="{{ $loop->index }}"
                                                                                                   {{ !empty(old('permissions')) ? (in_array($permRow['delete']->id, old('permissions', [])) ? 'checked' : '') : 'checked' }}>
                                                                                        </div>
                                                                                    @else
                                                                                        <span class="text-center">-</span>
                                                                                    @endif
                ...
                <div class="d-flex justify-content-end gap-3 align-items-center">
                    ...
                    <button type="submit" class="custom-btn orange-fill" {{ empty($permissions) ? 'disabled' : '' }}>Create</button>
                </div>
            </form>
