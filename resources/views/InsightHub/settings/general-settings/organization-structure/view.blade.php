...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid p-0">
        ...
        <div class="col-md-6 mb-md-0 mb-3">
            ...
            <p class="section-text">TalentCore</p>
        </div>
        <div class="col-md-6">
            <label class="section-label">Email Action</label>
            <p class="section-text">Registration OTP</p>
        </div>
    </div>
    ...
    <div class="mb-10">
        ...
        <p class="section-text">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mollis viverra condimentum. 
            Pellentesque fermentum sit amet ex in luctus. Vivamus pellentesque lacus ut tellus lacinia sodales.
        </p>
    </div>

    <div class="mb-10">
        <label class="section-label">Subject Line</label>
        <p class="section-text">Welcome to [Company Name]</p>
    </div>
    ...
    <div class="mb-10">
        ...
        <p class="section-text">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mollis viverra condimentum. 
            [Job Position] Pellentesque fermentum sit amet ex in luctus. Fusce id rhoncus enim. Vivamus 
            pellentesque lacus ut tellus lacinia sodales.
        </p>
    </div>
            </div>
