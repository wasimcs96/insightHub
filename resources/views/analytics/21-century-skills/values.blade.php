  ...
  <div class="row">
    ...
    @foreach($questions['domains'] as $domain)
      ...
      <div class="col-12 col-lg-6 mb-4">
        ...
        <div class="rounded-custom bg-white p-3 py-5 p-xl-5 shadow">

          <h4 class=" text-center">{{ $value['title'] }}</h4>

          <twenty-first-century-doghnut-chart :data='@json($questions)' value='{{ $value["title"] }}'></twenty-first-century-doghnut-chart>

          <p class="text-muted fs-08 mt-3 text-center">Percentage of talents who have scored low, moderate or high in the {{ $value["title"] }} skill</p>
