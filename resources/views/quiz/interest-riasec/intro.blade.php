...
@endsection
    ...
    <main>
        <div class="content-container container-1">
            <h2>CXS Work Interest Assessment</h2>
            <h1>RIASEC Work interests are used globally<br> to discover dream careers</h1>
            ...
            <div class="modal-content" style="background-color: #212121; color: white;">
                <div class="modal-body d-flex justify-content-center align-items-center" style="height: 100vh; margin: 0;">
                    <div class="box">
                        ...
                        <h1>Welcome to the RIASEC Work <br> Interest Test</h1>
                        <h4>Take your time to read each statement.<br> Indicate how important each Work Interest is to you using one of the five options.<br> Relax, be honest, go with the answer that feels right for<br> you and remember, there are no wrong answers! </h4>
                        <h4>There is no timer for this test, but it should take you<br> around 10 minutes to complete.</h4>
