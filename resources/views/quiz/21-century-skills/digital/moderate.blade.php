<div class="bg-white rounded-custom p-3 p-lg-5 shadow mb-5">
  ...
  <div>
    ...
    <a href="JavaScript:;" @click="collapse('custom-collapse11');$event.target.innerText == '{{ __('Your Results')}}' ? $event.target.innerText = '{{ __('Hide Results')}}' : $event.target.innerText = '{{ __('Your Results')}}'" class="btn btn-gradient rounded-custom px-5 fs-1-1 text-white">{{__("Your Results")}}</a>
