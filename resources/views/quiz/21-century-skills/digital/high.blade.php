<div class="bg-white rounded-custom p-3 p-lg-5 shadow mb-5">
  ...
  <div>
    ...
    <a href="JavaScript:;" @click="collapse('custom-collapse12');$event.target.innerText == '{{ __('Your Results')}}' ? $event.target.innerText = '{{ __('Hide Results')}}' : $event.target.innerText = '{{ __('Your Results')}}'" class="btn btn-gradient rounded-custom px-5 fs-1-1 text-white">{{__("Your Results")}}</a>
    ...
    <div class="row align-items-center mb-4">
      ...
      <div class="col">
        ...
        <div class="mb-3">
          ...
          <div class="text-muted fs-1-rem">{{__("This is an area of strength for you. It positions you well to access exciting opportunities in the world of work for the future.")}}</div>
