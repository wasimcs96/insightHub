...
<div class="full-size-bg-img work-values-bg-image-test py-5">
    ...
    <div class="container">
        ...
        <h1 class="color-white fs-3-rem fw-700 mb-5">{{__("Design your future today!")}}<br class="d-none d-lg-inline"> {{__("The Future of Work")}}</h1>
            ...
            <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                ...
                <div class="border-radius-20 bg-white overflow-hidden min-h-100">
                    ...
                    <div class="p-3">
                        ...
                        <p class="fw-600 color-dark-gray mb-5">{{__("To find out how ready you are for the work of the future.")}}</p>
            ...
            <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                ...
                <div class="border-radius-20 bg-white overflow-hidden min-h-100">
                    ...
                    <div class="p-3">
                        ...
                        <p class="fw-600 color-dark-gray mb-5">{{__("Which competencies are you already strong in and which should you develop more.")}}</p>
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="border-radius-20 bg-white overflow-hidden min-h-100">
                    ...
                    <div class="p-3">
                        ...
                        <p class="fw-600 color-dark-gray mb-5">{{__("Feedback on how your results a will help you prepare for the jobs and careers of the future.")}}</p>
        ...
        <div class="text-center">
            ...
            <h1 class="color-white mb-4">{{__("Welcome to the Future of Work Assessment")}}</h1>

            <p class="fw-600 fs-1-1">{{__("Take your time to read each statement.")}}<br>{{__("Indicate which statement best matches your view of yourself using one of the five options.")}}
                <br>{{__("Relax, be honest, go with the answer that feels right for you and remember, there are no wrong answers!")}}</p>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <button class="btn btn-gradient rounded-custom px-5 fs-1-1 text-white" name="submit" type="submit" value="submit" eventLabel="The Future of Work" @click="submitForm">{{__("Submit")}}</button>



                <button class="fw-600 fs-1-1 text-black save-continue-btn" name="submit" type="submit" value="submit_continue" eventLabel="The Future of Work" @click="submitForm">{{__("Save and continue later")}}</button>
