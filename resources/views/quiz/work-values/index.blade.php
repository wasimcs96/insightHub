...
<div class="full-size-bg-img work-values-bg-image-test py-5">
    ...
    <div class="container">
        ...
        <h1 class="color-white fs-3-rem fw-700 mb-5">{{ __("Design your future today!")}}<br class="d-none d-lg-inline"> {{ __("Your Work Values")}}</h1>
            ...
            <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                ...
                <div class="border-radius-20 bg-white overflow-hidden min-h-100">
                    ...
                    <div class="p-3">
                        ...
                        <p class="fw-600 color-dark-gray mb-5">{{ __("To find out the Work Values that matter most to you.")}}</p>
            ...
            <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                ...
                <div class="border-radius-20 bg-white overflow-hidden min-h-100">
                    ...
                    <div class="p-3">
                        ...
                        <p class="fw-600 color-dark-gray mb-5">{{ __("Which of the 18 Work Values are important to you.")}}</p>
        ...
        <div class="text-center">
            ...
            <h1 class="color-white mb-4">{{ __("Welcome to the Work Values Assessment")}}</h1>

            <p class="fw-600 fs-1-1">{{ __("Take your time to read each statement.")}}<br>{{ __("Indicate how important each Work Value is to you using one of the five options.")}}<br>{{ __("Relax, be honest, go with the answer that feels right for you and remember, there are no wrong answers!")}}</p>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-8">
            ...
            <div class="rounded-custom bg-white p-3 py-5 p-xl-5 shadow mb-5">
                ...
                <div class="p-3 border mb-5 bg-white shadow position-relative rounded-1-3">
                    ...
                    <div class="d-flex justify-content-between colorful-radios">
                        ...
                        <div class="text-center me-lg-5">
                            ...
                            <div class="fw-500 lh-1 mt-2 fs-xxs-07">{{ __("Unimportant")}}</div>
                        ...
                        <div class="text-center me-lg-5">
                            ...
                            <div class="fw-500 lh-1 mt-2 fs-xxs-07">{{ __("Little")}}<br>{{ __("Importance")}}</div>
                        ...
                        <div class="text-center me-lg-5">
                            ...
                            <div class="fw-500 lh-1 mt-2 fs-xxs-07">{{ __("Moderately")}}<br>{{ __("Important")}}</div>
                        ...
                        <div class="text-center me-lg-5">
                            ...
                            <div class="fw-500 lh-1 mt-2 fs-xxs-07">{{ __("Important")}}</div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="fw-500 lh-1 mt-2 fs-xxs-07">{{ __("Very")}}<br>{{ __("Important")}}</div>
                ...
                <form action="/quiz/{{ $questions['name'] }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <h3 class="mb-3 color-black">{{ __($value['title']) }}</h3>
                        ...
                        <div class="mb-4 pb-4 border-bottom">
                            ...
                            <div class="d-flex justify-content-between justify-content-lg-start colorful-radios">
                                ...
                                @for($i = $question['minPoints']; $i <= $question['maxPoints']; $i++ ) <div class="text-center me-lg-5">
                                    ...
                                    <input type="radio" id="test{{ $key.'-'.$k.'-'.$question['id'].'-'.$i }}" value="{{ $i }}" ref="question{{ $question['id'] }}{{ $i }}" name="answers[{{ $question['id'] }}]" @change="calculateCompletedPerc()" {{ $question['answer'] && $question['answer']['answer'] == $i ? "checked" : "" }}>

                                    <label for="test{{ $key.'-'.$k.'-'.$question['id'].'-'.$i }}">&nbsp;</label>

                                    <div class="fw-500 lh-1 mt-2 fs-xxs-07">{!! $i == 0 ? __('Unimportant') : ($i == 4 ? __('Very')."<br>".__('important') : "<div style='visibility:hidden'>".__('Very')."<br>".__('important')."</div>") !!}</div>
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <button class="btn btn-gradient rounded-custom px-5 fs-1-1 text-white" name="submit" type="submit" value="submit" eventLabel="Complete Work Value" @click="submitForm">{{ __("Submit")}}</button>



                <button class="fw-600 fs-1-1 text-black save-continue-btn" name="submit" type="submit" value="submit_continue" eventLabel="Complete Work Value" @click="submitForm">{{ __("Save and continue later")}}</button>


                <!-- <a href="#" class="fw-600 fs-1-1 text-black">Save and continue later</a> -->
        ...
        <div class="rounded-lg-custom bg-white p-3 p-lg-5 shadow sticky-top mb-lg-5 position-sm-fixed navigation border-top">
            ...
            <div class="d-lg-block scrollable-navigation" :class="{'d-block' : showNavigation, 'd-none' : !showNavigation}">
                ...
                <div class="d-flex align-content-start flex-wrap mx--8">
                    ...
                    <a href="#{{ strtolower(str_replace(' ', '-', $question['title'])) }}" class="navigation-circle m-2 fw-600 text-decoration-none" :class="{'active' : ($refs.question{{ $question['id'] }}0 && $refs.question{{ $question['id'] }}0.checked) || ($refs.question{{ $question['id'] }}1 && $refs.question{{ $question['id'] }}1.checked) || ($refs.question{{ $question['id'] }}2 && $refs.question{{ $question['id'] }}2.checked) || ($refs.question{{ $question['id'] }}3 && $refs.question{{ $question['id'] }}3.checked) || ($refs.question{{ $question['id'] }}4 && $refs.question{{ $question['id'] }}4.checked)}" @click="showNavigation = false">{{ $counter }}</a>
