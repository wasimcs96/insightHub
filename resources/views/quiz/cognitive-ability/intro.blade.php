...
@section('content')
    ...
    <main>
        <div class="content-container container-1">
            <h2>CXS Cognitive Ability Assessment</h2>
            <h1>Cognitive Ability Assessments are used <br> globally to measure cognitive skills and<br> potential for learning</h1>
            ...
            <div class="modal-content" style="background-color: #212121; color: white;">
                <div class="modal-body d-flex justify-content-center align-items-center" style="height: 100vh; margin: 0;">
                    <div class="box">
                        ...
                        <h1>Welcome to the Cognitive <br> Ability Assessment</h1>
                        <h4 style="text-align:justify;">Take your time to carefully read each question. Choose the answer that best reflects your reasoning from the provided options. Approach each question thoughtfully and use your analytical skills to determine the correct response.</h4>
                        <h4 style="text-align:center">You have <b>15 minutes</b> to complete this assessment, so manage your time accordingly.</h4><br>
                        <h4 style="text-align:justify; color:#212121; margin-bottom:20px; margin-top:-20px;"><b>Important Notice:</b> Once you start the assessment, ensure you're fully prepared and in a stable environment. <b style="color: black;"> Do not refresh or navigate away</b>, as the timer will continue and unanswered questions will be marked as blank when time expires. </h4>
                        <a href="/quiz/cognitive-ability-assessment">
