    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack ">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">
                    Employee {{ !empty($user) ? 'Edit' : 'Create' }} </li>
                <!--end::Item-->
            ...
            <div class="card-body">
                ...
                <form class="form" action="/admin/myemployee/{{ !empty($user) ? $user->id . '/update' : 'store' }}"
                    ...
                    <div class=" ">
                        ...
                        <h5 class="mt-20 mb-2">Emergency Contact Inormation</h5>
                        <div class="row w-100">
                            <div class="input-area col-lg-4">
...
<script>
    ...
    $(document).ready(function() {
        // Assume these values are passed from the server
        initCitySelect2('#higher_learning_institution', '{{ $user->higher_learning_institution ?? ''}}',
