                    ...
                    <div class="px-7 py-5">
                        ...
                        <form action="">
                            ...
                            <div class="mb-10">
                                ...
                                <!--begin::Input-->
                                <div>
                            <input type="text" class="form-control" value="{{ request('name') }}" name="name" placeholder="Search Sector By Name"> 
                                </div>
                                <!--end::Input-->
                            </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="/admin/jobs/index" class="btn btn-sm btn-light btn-active-light-primary me-2"
                ...
                <div id="kt_app_content_container" class="app-container  container-xxl ">
                    ...
                    <div class="row gx-6 gx-xl-9">
                        ...
                        <div class="col-xl-4 mb-4">
                            ...
                            <div  class="card bg-primary hoverable card-xl-stretch h-100">
                                <!--begin::Body-->
                                <div class="card-body">
                                    <iconify-icon icon="{{ $value['icon'] ?? 'arcticons:emoji-department-store' }}" width="64" height="64"></iconify-icon>
        
                                    <div class="text-white fw-bold fs-2 mb-2 mt-5">
                                        <a href="{{ route('admin.saved.jobdescriptions',['org_department'=>$value['id'],'saved_job'=>request('saved_job')]) }}" class="text-white fw-bold fs-2 ">
                                        {{ $key }}
                                        </a>
                                    </div>
        
                                    <div class="d-flex fs-2 fw-bold justify-content-between mb-2 mt-5">
        
                                       <p> {{ $value['count'] }} </p> <a href="/admin/export/company/jobdescriptions/{{ $value['id'] }}"><iconify-icon icon="clarity:export-solid" class="fa-1-5 text-dark"></iconify-icon></a></div>
