                        ...
                        <form action="">
                            <div class="form-group d-flex justify-content-evenly col-lg-12 p-0">
                                <div class="col-lg-4">
                                    ...
                                    <input id="sector" class="form-control" placeholder="Select the Sector"
                                        style="
                                    background: #ffffff;
                                "
                                        readonly>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input id="job_role" class="form-control" placeholder="Job Role"
                                        style="
                                    background: #ffffff;
                                "
                                        readonly>
                ...
                <div class="card  shadow-sm mb-4">
                    ...
                    <div class="card-body  py-5">
                        <div class="mb-5">
                            ...
                            <textarea class="form-control" name="jobRoleDescription" data-kt-autosize="true" rows="5" cols="50"></textarea>
                        </div>
                        <div class="mb-5 row">
                        ...
                        <div class="mb-5 row">
                            <div class="fv-row mb-7 fv-plugins-icon-container col-lg-12" style="padding: 0px">
                                ...
                                <input id="headcount" type="text" class="form-control  mb-lg-0" name="headcount"
...
@section('scripts')
    ...
    <script>
        ...
        function populateForm(data) {
            ...
            document.querySelector('textarea[name="jobRoleDescription"]').value = data.description || '';
