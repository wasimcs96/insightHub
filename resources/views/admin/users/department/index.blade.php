            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <!--begin::Add user-->
                        <a href="/admin/department/user/create/" class="btn btn-primary d-flex align-items-center">
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="/admin/department/user/{{$user->id}}/edit">
                                        <div class="symbol-label">
                                            @if(isset($user->user->profile_picture) && File::exists(public_path($user->user->profile_picture)))
                                            <img src="{{ asset($user->user->profile_picture) }}" alt="{{$user->name ?? ''}}"
                                                class="w-100" />
                                            @else
                                            <img src="{{ asset('images/default-user.svg') }}" alt="{{$user->name ?? ''}}"
                                                class="w-100" />
                                            @endif
                                        </div>
                                    </a>
                            ...
                            <td class="text-center">
                                ...
                                <a href="/admin/department/user/{{$user->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="/admin/department/user/{{$user->id}}/delete" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                    <iconify-icon icon="iconamoon:trash-light" class="fa-1-5"></iconify-icon>
                                </a>
                            </td>
                        </tr>
