    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack ">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">
                    <a href="/admin/employee/users" class="capitalize text-muted text-hover-primary">
                        Employee
                    </a>
                </li>
                <!--begin::Item-->
    ...
    <div id="kt_app_content_container" class="app-container  container-xxl ">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form" action="/admin/employee/user/{{ !empty($user) ? $user->id . '/update' : 'store' }}"
                    ...
                    <div class=" ">
                        ...
                        <div class="fv-row mb-7 row">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" id="company" data-control="select2"
                                    ...
                                    <option value="{{ $com->id }}" @if(isset($user)&& $com->id == $user->company_id) selected @endif>{{ $com->name ?? '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" id="department" data-control="select2"
                                    data-hide-search="true" data-placeholder="Select a Department" name="department_id">
                                    <option value="{{ $user->department_id ?? '' }}" selected>{{ $user->department->name ?? 'Select Department' }}</option>
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" id="positions" data-control="select2"
                                    data-hide-search="true" data-placeholder="Select a Team Member" name="position_id">
                                    <option value="{{ $user->position_id ?? '' }}" selected>{{ $user->job_position->title ?? 'Select Position' }}</option>
                        ...
                        <div class="fv-row mb-7 row">
                            ...
                            {{-- <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" id="role" data-control="select2"
                                    data-hide-search="false" data-placeholder="Select a Role" name="role_id">
