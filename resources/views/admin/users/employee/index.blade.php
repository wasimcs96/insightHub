            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <!--begin::Add user-->
                        <a href="/admin/employee/user/create/" class="btn btn-primary d-flex align-items-center">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="/admin/employee/user/{{$user->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                ...
                                <a href="/admin/employee/user/{{$user->id}}/delete" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                    <iconify-icon icon="iconamoon:trash-light" class="fa-1-5"></iconify-icon>
                                </a>
                            </td>
                        </tr>
