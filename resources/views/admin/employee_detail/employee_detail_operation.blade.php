            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#"
                                            ...
                                            @if (isset($growth_potential_result) && strtolower($growth_potential_result) == 'super high')
                                            ...
                                            @elseif (isset($growth_potential_result) && strtolower($growth_potential_result) == 'very high')
                                                <iconify-icon icon="codicon:verified-filled" class="toolTip onTop ml-2"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Average Potential "
                                            style="
                    ...
                    <ul class="nav nav-tabs nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 " href="#">Operations</a>
                        </li>
                        <!--end::Nav item-->
                    </ul>
                    <!--begin::Navs-->
                            ...
                            <div class="card  mb-xl-8 overflow-hidden">
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <div class="mb-2 p-2">
                                        ...
                                        @foreach (json_decode($employee->professional_certificate, true) as $skill)
                                            <div class="badge badge-success">{{ $skill['value'] }}</div>
                                        @endforeach
                                        @endif
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mt-5">
                            <div class="card h-full shadow-base2">
                                ...
                                <div class="card-body p-6">
                                    @if ($employee->is_personality_motivation_completed == 1)
                                    ...
                                    function renderFinalFacetHtml($facet_low, $facet_field_name, $facet, $oceanAllFacetsEmployeeAResult, $oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) {

                                        // Extracting the property values from objects
                                        $facet_value_a = isset($oceanAllFacetsEmployeeAResult->$facet_field_name) ? $oceanAllFacetsEmployeeAResult->$facet_field_name : 0;
                                        ...
                                        <div class="">
                                            <div class="slider-container cursor-pointer" data-bs-toggle="modal"
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($oceanSelfResult['Openness to Experience']) && ($oceanSelfResult['Openness to Experience'] / 5) * 100 == 100) style="left: 93%;" @else style="left: {{ ($oceanSelfResult['Openness to Experience'] / 5) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                            ...
                                            <div class="slider-container cursor-pointer" data-bs-toggle="modal"
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($oceanSelfResult['Conscientiousness']) && ($oceanSelfResult['Conscientiousness'] / 5) * 100 == 100) style="left: 93%;" @else style="left: {{ ($oceanSelfResult['Conscientiousness'] / 5) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                            ...
                                            <div class="slider-container cursor-pointer" data-bs-toggle="modal"
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($oceanSelfResult['Extraversion']) && ($oceanSelfResult['Extraversion'] / 5) * 100 == 100) style="left: 93%;" @else style="left: {{ ($oceanSelfResult['Extraversion'] / 5) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                            ...
                                            <div class="slider-container cursor-pointer" data-bs-toggle="modal"
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($oceanSelfResult['Agreeableness']) && ($oceanSelfResult['Agreeableness'] / 5) * 100 == 100) style="left: 93%;" @else style="left: {{ ($oceanSelfResult['Agreeableness'] / 5) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                            ...
                                            <div class="slider-container cursor-pointer" data-bs-toggle="modal"
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($oceanSelfResult['Emotional Stability']) && ($oceanSelfResult['Emotional Stability'] / 5) * 100 == 100) style="left: 93%;" @else style="left: {{ ($oceanSelfResult['Emotional Stability'] / 5) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                        ...
                                        <div class="">
                                            <div class="slider-container">
                                                <div class="slider-label accordion-button cursor-pointer"
                                                    data-bs-toggle="collapse" data-bs-target="#criticalThinkingAccordion">
                                                    Critical
                                                    Thinking <span>
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($workCompetencyResult['Critical Thinking']) && $workCompetencyResult['Critical Thinking'] == 100) style="left: 93%;" @else style="left: {{ $workCompetencyResult['Critical Thinking'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                            ...
                                            <div class="accordion-item pl-8">
                                                ...
                                                <div id="criticalThinkingAccordion"
                                                    ...
                                                    <div class="accordion-body font13 text-slate-600">
                                                        ...
                                                        well, and communicating effectively, especially in
                                                        writing.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slider-container">
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($workCompetencyResult['Creativity']) && $workCompetencyResult['Creativity'] == 100) style="left: 93%;" @else style="left: {{ $workCompetencyResult['Creativity'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                                        style="left: {{ $workCompetencyOverallResult['Creativity'] ?? 0 }}%;">
                                                        P</div>
                                            ...
                                            <div class="slider-container">
                                                <div class="slider-label accordion-button cursor-pointer"
                                                    data-bs-toggle="collapse" data-bs-target="#communicationAccordion">
                                                    Communication
                                                    <span>
                                                        <iconify-icon icon="iconamoon:arrow-down-2-light">
                                                        </iconify-icon>
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($workCompetencyResult['Communication']) && $workCompetencyResult['Communication'] == 100) style="left: 93%;" @else style="left: {{ $workCompetencyResult['Communication'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                                        style="left: {{ $workCompetencyOverallResult['Communication'] ?? 0 }}%;">
                                                        P</div>
                                            ...
                                            <div class="slider-container">
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($workCompetencyResult['Leadership']) && $workCompetencyResult['Leadership'] == 100) style="left: 93%;" @else style="left: {{ $workCompetencyResult['Leadership'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                                        style="left: {{ $workCompetencyOverallResult['Leadership'] ?? 0 }}%;">
                                                        P</div>
                                            ...
                                            <div class="accordion-item pl-8">
                                                ...
                                                <div id="leadershipAccordion"
                                                    ...
                                                    aria-labelledby="panelsStayOpen-headingOne">
                                                    <div class="accordion-body font13 text-slate-600">
                                                        Demonstrates strong leadership, proactively takes
                                                        charge, and assumes responsibility.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slider-container">
                                                <div class="slider-label accordion-button cursor-pointer"
                                                    data-bs-toggle="collapse" data-bs-target="#teamworkAccordion">Teamwork
                                                    <span>
                                                        <iconify-icon icon="iconamoon:arrow-down-2-light">
                                                        </iconify-icon>
                                                    </span>
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($workCompetencyResult['Teamwork']) && $workCompetencyResult['Teamwork'] == 100) style="left: 93%;" @else style="left: {{ $workCompetencyResult['Teamwork'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                                        style="left: {{ $workCompetencyOverallResult['Teamwork'] ?? 0 }}%;">
                                                        P</div>
                                            ...
                                            <div class="accordion-item pl-8">
                                                ...
                                                <div id="teamworkAccordion"
                                                    ...
                                                    aria-labelledby="panelsStayOpen-headingOne">
                                                    <div class="accordion-body font13 text-slate-600">
                                                        Prioritizes team and client needs, works well with
                                                        others, and aligns personal values with the
                                                        organization.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="slider-container">
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($workCompetencyResult['Adaptability']) && $workCompetencyResult['Adaptability'] == 100) style="left: 93%;" @else style="left: {{ $workCompetencyResult['Adaptability'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                                        style="left: {{ $workCompetencyOverallResult['Adaptability'] ?? 0 }}%;">
                                                        P</div>
                                            ...
                                            <div class="accordion-item pl-8">
                                                ...
                                                <div id="adaptabilityAccordion"
                                                    ...
                                                    aria-labelledby="panelsStayOpen-headingOne">
                                                    <div class="accordion-body font13 text-slate-600">
                                                        Adapts to change, handles stress effectively, and
                                            ...
                                            <div class="slider-container">
                                                <div class="slider-label accordion-button cursor-pointer"
                                                    ...
                                                    data-bs-target="#systematicPlanningAccordion">
                                                    Systematic
                                                    Planning <span>
                                                        <iconify-icon icon="iconamoon:arrow-down-2-light">
                                                        </iconify-icon>
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($workCompetencyResult['Systematic Planning']) && $workCompetencyResult['Systematic Planning'] == 100) style="left: 93%;" @else style="left: {{ $workCompetencyResult['Systematic Planning'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                                        style="left: {{ $workCompetencyOverallResult['Systematic Planning'] ?? 0 }}%;">
                                                        P</div>
                                            ...
                                            <div class="accordion-item pl-8">
                                                ...
                                                <div id="systematicPlanningAccordion"
                                                    ...
                                                    aria-labelledby="panelsStayOpen-headingOne">
                                                    <div class="accordion-body font13 text-slate-600">
                                                        Plans and organizes work systematically, follows
                                                        procedures, and focuses on providing quality service.
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="slider-container">
                                                <div class="slider-label accordion-button cursor-pointer"
                                                    data-bs-toggle="collapse"
                                                    data-bs-target="#achievementOreientationAccordion">
                                                ...
                                                <div class="slider-track">
                                                    <div class="emp_a"
                                                        @if (isset($workCompetencyResult['Achievement Orientation']) && $workCompetencyResult['Achievement Orientation'] == 100) style="left: 93%;" @else style="left: {{ $workCompetencyResult['Achievement Orientation'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    <div class="emp_b population_hide hidden_population"
                                                        style="left: {{ $workCompetencyOverallResult['Achievement Orientation'] ?? 0 }}%;">
                                                        P</div>
                                            ...
                                            <div class="accordion-item pl-8">
                                                ...
                                                <div id="achievementOreientationAccordion"
                                                    ...
                                                    <div class="accordion-body font13 text-slate-600">
                                                        ...
                                                        understands business essentials, and seeks personal
                        ...
                        <div class="col-lg-6 mt-5">
                            <div class="card h-full shadow-base2">
                                ...
                                <div class="card-body p-6">
                                    @if ($employee->is_work_interest_completed == 1)
                                        {{-- <div id="riasec" class="align-items-center col-lg-3 d-flex justify-content-center">
                                    </div> --}}

                                        <div class="">
                                            @php
                                                $topriasec = $workInterestOverallResult['top_3_riasec_array'];
                                            @endphp

                                            <div
                                                class="slider-container @if (in_array('R', $topriasec)) raisec_container @endif my-1">
                                                ...
                                                ">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($workInterestResult['Realistic']) && $workInterestResult['Realistic'] == 100) style="left: 93%;" @else style="left: {{ $workInterestResult['Realistic'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    {{-- <div class="emp_b population_hide hidden_population"
                                                    style="left: {{ $workInterestOverallResult['Realistic'] ?? 0 }}%;">
                                                P
                                                </div> --}}
                                            ...
                                            <div
                                                class="slider-container @if (in_array('I', $topriasec)) raisec_container @endif my-1">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($workInterestResult['Investigative']) && $workInterestResult['Investigative'] == 100) style="left: 93%;" @else style="left: {{ $workInterestResult['Investigative'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    {{-- <div class="emp_b population_hide hidden_population"
                                            ...
                                            <div
                                                class="slider-container @if (in_array('A', $topriasec)) raisec_container @endif my-1">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($workInterestResult['Artistic']) && $workInterestResult['Artistic'] == 100) style="left: 93%;" @else style="left: {{ $workInterestResult['Artistic'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    {{-- <div class="emp_b population_hide hidden_population"
                                                                    style="left: {{ $workInterestOverallResult['Artistic'] ?? 0 }}%;">
                                                        P
                                                    </div> --}}
                                            ...
                                            <div
                                                class="slider-container @if (in_array('S', $topriasec)) raisec_container @endif my-1">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($workInterestResult['Social']) && $workInterestResult['Social'] == 100) style="left: 93%;" @else style="left: {{ $workInterestResult['Social'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    {{-- <div class="emp_b population_hide hidden_population"
                                                                style="left: {{ $workInterestOverallResult['Social'] ?? 0 }}%;">
                                                P
                                                </div> --}}
                                            ...
                                            <div
                                                class="slider-container @if (in_array('E', $topriasec)) raisec_container @endif my-1">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($workInterestResult['Enterprising']) && $workInterestResult['Enterprising'] == 100) style="left: 93%;" @else style="left: {{ $workInterestResult['Enterprising'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    {{-- <div class="emp_b population_hide hidden_population"
                                                                    style="left: {{ $workInterestOverallResult['Enterprising'] ?? 0 }}%;">
                                                P
                                                </div> --}}
                                            ...
                                            <div
                                                class="slider-container @if (in_array('C', $topriasec)) raisec_container @endif my-1">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($workInterestResult['Conventional']) && $workInterestResult['Conventional'] == 100) style="left: 93%;" @else style="left: {{ $workInterestResult['Conventional'] ?? 0 }}%;" @endif>
                                                    </div>
                                                    {{-- <div class="emp_b population_hide hidden_population"
                                                                        style="left: {{ $workInterestOverallResult['Conventional'] ?? 0 }}%;">
                                                P
                                            </div> --}}
                            ...
                            <div class="card h-full shadow-base2 mt-5">
                                ...
                                <div class="card-body p-6">
                                    @if ($employee->is_cognitive_ability_completed == 1)
                                        ...
                                        <div class="mt-5">
                                            <div class="slider-container">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($cognitiveEmployeeAResult['Quantitative Knowledge']) &&
                                                                $cognitiveEmployeeAResult['Quantitative Knowledge'] / 3 == 1) style="left: 93%;" @else style="left: {{ ($cognitiveEmployeeAResult['Quantitative Knowledge'] / 3) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                            ...
                                            <div class="slider-container">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($cognitiveEmployeeAResult['Comprehension Knowledge']) &&
                                                                $cognitiveEmployeeAResult['Comprehension Knowledge'] / 3 == 1) style="left: 93%;" @else style="left: {{ ($cognitiveEmployeeAResult['Comprehension Knowledge'] / 3) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                                </div>
                                                {{-- <div class="slider-label">Openness</div> --}}
                                            </div>
                                            <div class="slider-container">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($cognitiveEmployeeAResult['Visual Reasoning']) && $cognitiveEmployeeAResult['Visual Reasoning'] / 3 == 1) style="left: 93%;" @else style="left: {{ ($cognitiveEmployeeAResult['Visual Reasoning'] / 3) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                                </div>
                                                {{-- <div class="slider-label">Openness</div> --}}
                                            </div>
                                            <div class="slider-container">
                                                ...
                                                <div class="slider-track">
                                                    ...
                                                    <div class="emp_a"
                                                        @if (isset($cognitiveEmployeeAResult['Fluid Reasoning']) && $cognitiveEmployeeAResult['Fluid Reasoning'] / 3 == 1) style="left: 93%;" @else style="left: {{ ($cognitiveEmployeeAResult['Fluid Reasoning'] / 3) * 100 ?? 0 }}%;" @endif>
                                                    </div>
                                                </div>
                                                {{-- <div class="slider-label">Openness</div> --}}
                                            </div>
                                            ...
                                            <div class="accordion accordion-icon-collapse" id="kt_accordion_2">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <div class="accordion-header py-3 d-flex" data-bs-toggle="collapse"
                                                        ...
                                                        <h3 class="fs-4 fw-semibold mb-0 ms-4">
                                                            {{ ucfirst($employee->flight_risk_level) ?? 'Moderate' }}</h3>
                                                    </div>
                                                    <!--end::Header-->
                                                    ...
                                                    <div id="kt_accordion_3_item_3" class="fs-6 collapse show ps-10"
                                                        ...
                                                        @if (isset($employee->flight_risk_level) && $employee->flight_risk_level == 'high')
                                            ...
                                            <div class="accordion accordion-icon-collapse" id="kt_accordion_4">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <div class="accordion-header py-3 d-flex" data-bs-toggle="collapse"
                                                        ...
                                                        <h3 class="fs-4 fw-semibold mb-0 ms-4">
                                                            {{ ucfirst($organizational_fit_forecast_result) ?? 'Moderate' }}
                                                            Risk</h3>
                                                    </div>
                                                    <!--end::Header-->
                                                    ...
                                                    <div id="kt_accordion_3_item_4" class="fs-6 collapse show ps-10"
                                                        ...
                                                        @if (isset($organizational_fit_forecast_result) && $organizational_fit_forecast_result == 'high')
                                                            ...
                                                            negatively.
                                                        @elseif(isset($organizational_fit_forecast_result) && $organizational_fit_forecast_result == 'low')
                                            ...
                                            <div class="accordion accordion-icon-collapse" id="kt_accordion_4">
                                                ...
                                                <div class="mb-5">
                                                    ...
                                                    <div class="accordion-header py-3 d-flex" data-bs-toggle="collapse"
                                                        ...
                                                        <h3 class="fs-4 fw-semibold mb-0 ms-4">
                                                            {{ ucfirst($growth_potential_result) ?? 'Average' }}</h3>
                                                    </div>
                                                    <!--end::Header-->
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="">
                            ...
                            {!! renderFinalFacetHtml('Practicality', 'daydreaming_avg','Day Dreaming', $oceanAllFacetsEmployeeAResult, $oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Practical Aesthetics', 'aesthetic_appreciation_avg','Aesthetic Appreciation', $oceanAllFacetsEmployeeAResult, $oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Measured Emotionality', 'feeling_aware_avg','Feeling Aware', $oceanAllFacetsEmployeeAResult, $oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Consistent Reliability', 'explorer_avg','Explorer', $oceanAllFacetsEmployeeAResult, $oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Realistic Pragmatism', 'innovation_avg','Innovation', $oceanAllFacetsEmployeeAResult, $oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Traditional Values', 'daydreaming_avg','Open Mindedness', $oceanAllFacetsEmployeeAResult, $oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        ...
        rounded-md outline-none text-current">
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="">
                            {!! renderFinalFacetHtml('Humble Capability', 'self_confidence_avg','Self Confidence', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Flexibility', 'tidiness_avg','Tidiness', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Autonomy', 'responsibility_avg','Responsibility', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Contentment', 'drive_to_achieve_avg','Drive To Achieve', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Spontaneity', 'will_power_avg','Will Power', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Impulsiveness', 'careful_thinking_avg','Careful Thinking', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        ...
        rounded-md outline-none text-current">
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="">
                            {!! renderFinalFacetHtml('Reservedness', 'sociability_avg','Sociability', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Independence', 'crowd_enjoyment_avg','Crowd Enjoyment', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Humility', 'confidence_avg','Confidence', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Calmness', 'sociability_avg','Sociability', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Risk Aversion', 'thrill_seeking_avg','Thrill Seeking', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Composed Outlook', 'optimism_avg','Optimism', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        ...
        rounded-md outline-none text-current">
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="">
                            {!! renderFinalFacetHtml('Skepticism', 'belief_avg','Belief', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Tactfulness', 'honesty_avg','Honesty', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Self-Reliance', 'helpfulness_avg','Helpfulness', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Self-Assuredness', 'diplomacy_avg','Diplomacy', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Self-Belief', 'humility_avg','Humility', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Tough-Mindedness', 'compassion_avg','Compassion', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        ...
        rounded-md outline-none text-current">
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="">
                            {!! renderFinalFacetHtml('Stress Sensitivity', 'steadiness_avg','Steadiness', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Irritability', 'tolerance_avg','Tolerance', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Discouragement', 'positivity_avg','Positivity', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Self-Doubt', 'social_sensitivity_avg','Social Sensitivity', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Stress Prone', 'stress_response_avg','Stress Response', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
                            {!! renderFinalFacetHtml('Tactfulness', 'honesty_avg','Honesty', $oceanAllFacetsEmployeeAResult,$oceanAllFacetsOverallResult, $allHighFacets, $allLowFacets, $allFacetsDescriptions) !!}
            ...
            series: [
                {
                    ...
                    data: [
                        { x: "R", y: {{$workInterestResult['Realistic']}} },
                        { x: "I", y: {{$workInterestResult['Investigative']}} },
                        { x: "A", y: {{$workInterestResult['Artistic']}} },
                        { x: "S", y: {{$workInterestResult['Social']}} },
                        { x: "E", y: {{$workInterestResult['Enterprising']}} },
                        { x: "C", y: {{$workInterestResult['Conventional']}} }
