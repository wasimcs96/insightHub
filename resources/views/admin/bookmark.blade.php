    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack ">
        ...
        <form class="d-flex align-items-center overflow-auto" action="">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="/admin/bookmarks" class="btn btn-sm btn-icon btn-light me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset">
                    <iconify-icon icon="bx:reset" class="fa-2x"></iconify-icon>
                </a>
                <button class="btn btn-sm btn-icon btn-light-success " value="export" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset">
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">Bookmarked Employees</span>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-50px me-5">
                                            <img src="{{asset($bookmark->profile_picture)}}" onerror="this.src='{{ asset('admin/media/avatars/default-avatar.png') }}'" class="" alt="" />
