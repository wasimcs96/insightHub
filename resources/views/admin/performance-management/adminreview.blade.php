                        ...
                        <form id="filter-form" action="{{ route('admin.performance.management.filterUsers') }}" method="GET">
                            ...
                            <select class="form-select form-select-solid me-6" data-control="select2"
                                ...
                                <option value="mid_year"
                                    class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">Mid Year
                                </option>
                                <option value="end_year"
                                    class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">End Year
                                </option>
        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    <h2 class="capitalize">Pending Review List
                    </h2>
                </div>
                <!--begin::Card title-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="/admin/employee-details/{{ $review['userData']->id }}">
                                        <div class="symbol-label">
                                            ...
                                            @else
                                            <img src="{{ asset('images/default-user.svg') }}" alt="{{ $review['userData']->first_name . ' ' . $review['userData']->last_name }}" class="w-100" />
                                            @endif
                                        </div>
                                    </a>
                                </div>
                            ...
                            <td>{{ $review['userData']->department && $review['userData']->department->head_of_department ? $review['userData']->department->head_of_department : '' }}</td>
                            <td>{{ $review['userData']->job_position->title ?? '' }}</td>
                            <td>
                                @if(isset($review['reviewDetails']->kpi_type))
                                @if($review['reviewDetails']->kpi_type == 'mid-year')
                                Mid Year
                                @elseif($review['reviewDetails']->kpi_type == 'end-year')
                                End Year
                                @elseif($review['reviewDetails']->kpi_type == 'planning')
                                Planning
                                @else
                                {{ $review['reviewDetails']->kpi_type }}
                                @endif
                                @else
                                {{-- Optional: Display something if kpi_type is not set --}}
                                @endif
                            </td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="/admin/performance/approve/{{$review['kpiId']}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 mb-2">
