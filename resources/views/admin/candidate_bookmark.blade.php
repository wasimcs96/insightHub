    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack ">
        ...
        <form class="d-flex align-items-center overflow-auto" action="">
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="/admin/candidate/bookmarks" class="btn btn-sm btn-icon btn-light me-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Reset">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-gray-900 fw-bold text-center text-hover-primary d-block mb-1 fs-6">
                                        ...
                                        <iconify-icon icon="codicon:verified-filled" class="" data-bs-toggle="tooltip"
                                        ...
                                        <iconify-icon icon="codicon:verified" class="" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="High Potential " data-tippy-theme="dark" style="background: #16b7f9;border-radius: 50%;font-size: x-large;"></iconify-icon>

                                        @else
                                        <iconify-icon icon="solar:verified-check-broken" class="" data-bs-toggle="tooltip"
