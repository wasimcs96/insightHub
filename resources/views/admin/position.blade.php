...
@section('title',  'Level '.$levelOfPosition )
        ...
        <form class="d-flex align-items-center overflow-auto" action="">
            ...
            {{-- <form action="d-flex align-items-center overflow-auto"> --}}
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="/admin/position/{{ $level }}" class="btn btn-sm btn-icon btn-light me-3" data-bs-toggle="tooltip"
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">{{ 'Level '.$levelOfPosition ?? 'Other' }}</span>
