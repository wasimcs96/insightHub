...
@section('title', 'Import Descriptor')
    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_toolbar_container'}" class="page-title d-flex flex-column justify-content-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    {{ !empty($user) ? 'Edit Descriptor' : 'Import Descriptor' }}
                </li>
            </ul>
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card">
            <div class="card-body">
            <a href="{{ route('descriptors.download-template') }}" class="btn btn-primary mb-3">Download Template</a>

                <form class="form" action="{{ route('descriptors.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf

                      <legend class="">Import Descriptor</legend>
                      ...
                      <div class="d-flex justify-content-between align-items-center mt-3 mt-5">
                        <button type="submit" class="btn btn-sm btn-primary mb-3">{{ trans('Import Descriptor') }}</button>
                    </div>
