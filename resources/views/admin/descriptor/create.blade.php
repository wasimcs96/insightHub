    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_toolbar_container'}" class="page-title d-flex flex-column justify-content-center flex-wrap me-3 mb-5 mb-lg-0">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    {{ !empty($user) ? 'Edit Descriptor' : 'Create Descriptor' }}
                </li>
            </ul>
        </div>
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card">
            <div class="card-body">
                <form action="{{route('descriptors.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!-- Name Field -->
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <input type="number" name="job_requirement_level" class="form-control form-control-solid @error('job_requirement_level') is-invalid @enderror" placeholder="Enter Job Requirement Level" required>
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <input type="number" name="population_score_level" class="form-control form-control-solid @error('population_score_level') is-invalid @enderror" placeholder="Enter Population Score Level" required>
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <input type="number" name="user_score_level" class="form-control form-control-solid @error('user_score_level') is-invalid @enderror" placeholder="Enter User Score Level" required>
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <input type="text" name="job_requirement_level_description" class="form-control form-control-solid @error('job_requirement_level_description') is-invalid @enderror" placeholder="Enter Job Requirement Level Description" required>
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <input type="text" name="population_score_level_description" class="form-control form-control-solid @error('population_score_level_description') is-invalid @enderror" placeholder="Enter Population Score Level Description" required>
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <input type="text" name="user_score_level_description" class="form-control form-control-solid @error('user_score_level_description') is-invalid @enderror" placeholder="Enter User Score Level Description" required>
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <select id="result_type" name="result_type" class="form-control">
                                ...
                                <option value="all_facets">All Facets</option>
                                <option value="job_match_rate">Job Match Rate</option>
                                ...
                                <option value="organization_fit_forecast">Organization Fit Forecast</option>
                                <option value="flight_risk">Flight Risk</option>
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <textarea id="analysis" name="analysis" class="form-control" rows="3"></textarea>
                            @error('analysis')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        </div>
                        ...
                        <div class="col-lg-6 mb-5">
                            ...
                            <textarea id="analysis_population" name="analysis_population" class="form-control" rows="3"></textarea>
