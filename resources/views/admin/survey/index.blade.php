        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    <h2 class="capitalize"> Survey List</h2>
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <a href="{{route('survey.create')}}" class="btn btn-primary d-flex align-items-center">
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('survey.edit', $value->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    <iconify-icon icon="heroicons-outline:pencil-alt" class="fa-1-5"></iconify-icon>
                                </a>
                                <form action="{{ route('surveys.destroy', $value->id) }}" id="form-{{ $value->id }}" class="d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <a href="{{ route('admin.recordDetails', $value->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="View Record Details">
                                    <i class="fas fa-record-vinyl" style="font-size: 1.5em; color: #007bff;"></i>
                                </a>
