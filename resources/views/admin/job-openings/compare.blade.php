                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            <a href="{{ route('admin.job-applicant.show',$job_opening_id) }}" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="card-body" style="padding: 0px;">
                    @if(!$data)
                        <div class="text-center py-5">
                            <h3>No comparison data available. Please select users to compare.</h3>
                        </div>
                    @else
                        <table>
                            <thead>
                                ...
                                @php
                                    $fields = [
                                        ...
                                        'Suggestion' => [
                                            'key' => 'suggestion',
                                            'value' => function($single) {
                                                // if(isset($single['match_rate']) && ($single['match_rate'] != 0) && isset($single['interview_score']) && ($single['interview_score'] != 0)) {
                                                ...
                                                // return $value;
                                                return config('helpers.suggestion_levels')[$single['suggestion']];
                                            },
                                            'description' => function($single) {
                                                // if(isset($single['match_rate']) && ($single['match_rate'] != 0) && isset($single['interview_score']) && ($single['interview_score'] != 0)) {
                                                //     $value = $single['suggestion'] ?? 0;
                                                ...
                                                // return $value;
                                                // return config('helpers.suggestion_levels')[$single['suggestion']];
                                                return $single['suggestion_description'] ?? ' '; 
                                            }
                                        ],
                                        'Interview Performance' => [
                                            ...
                                            'value' => function($single) {
                                                ...
                                                return config('helpers.interview_levels')[$single['interview_performance']];
                                            },
                                            'description' => function($single) {
                                                // $value = $single['interview_score'] ?? 0;
                                                // return $value;
                                                return $single['interview_performance_description'] ?? '';
                                            }
                                        ],
                                        ...
                                        'Suitability Rate' => [
                                            ...
                                            'value' => function($single) {
                                                ...
                                                return config('helpers.suitability_rate_levels')[$single['suitability_rate']];
                                            },
                                            'description' => function($single) {
                                                // $value = $single['suitability_rate'] ?? 0;
                                                // return $value;
                                                // return config('helpers.suitability_rate_levels')[$single['suitability_rate']];
                                                return $single['suitability_rate_description'] ?? '';
                                            }
                                        ],
