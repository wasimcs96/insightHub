    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack ">
        ...
        <form class="d-flex align-items-center overflow-auto" action="">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="/admin/job-opening/completed-interview-list" class="btn btn-sm btn-icon btn-light me-3" data-bs-toggle="tooltip"
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">Completed Interview Listings</span>
                </h3>
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            <thead>
                                <tr class="fw-bold text-muted bg-light">
                                    ...
                                    <th class="min-w-125px text-center">Suggestions</th>
                                    ...
                                    @foreach($interviewLists as $interviewList)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="text-gray-900 text-center fw-bold text-hover-primary d-block mb-1 fs-6">
                                                    @php
                                                        $match_rate = $interviewList->match_rate ?? 0;
                                                        $interview_score = $interviewList->interview_score ?? 0;
