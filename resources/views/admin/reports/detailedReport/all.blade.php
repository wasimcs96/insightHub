                            ...
                            <header
                                ...
                                <div class="flex-1">
                                    <div class="card-title text-slate-900 dark:text-white">Detailed Reports <a
                                            href="/admin/detailed/report/export/all"
                                        ...
                                        <div class="card-body px-6 pb-6">
                                            <div class="card-body">
                                                <header
                                                    class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                                                    <div class="flex-1">
                                                        <div class="card-title text-slate-900 dark:text-white">CAA </div>
                                                    </div>
                                                </header>
                                                <div class="badge-group">
                                                    <span class="badge bg-primary-500 text-white mx-5 mb-4"
                                                        data-v-d70534ce="">
                                            ...
                                            <div class="card-body">
                                                <header
                                                    class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                                                    <div class="flex-1">
                                                        <div class="card-title text-slate-900 dark:text-white">OCEAN </div>
                                                    </div>
                                                </header>
                                                <div class="badge-group mb-5 w-0">
                                                    <table
                                                        ...
                                                        <thead class="">
                                                            <tr>
                                                                <th scope="col"
                                                                    class="legend_th table-th border border-slate-600  "
                                                                    style="
                                                            background: white;
                                                            color: black;
                                                        ">
                                                                ...
                                                                <th scope="col"
                                                                    class="legend_th table-th border border-slate-600 dark:bg-slate-800 dark:border-slate-700 ">
                                                                    Very Inaccurate
                                                                </th>
                                                        ...
                                                        <tbody
                                                            ...
                                                            <tr>
                                                                <td
                                                                    class="legend-title table-th border border-slate-600 dark:bg-slate-800 dark:border-slate-700">
                                                                    + Keyed</td>
                                                                ...
                                                                <table id="students-table"
                                                                    ...
                                                                    <thead class=" bg-slate-200 dark:bg-slate-700">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @foreach (range(1, 120) as $question)
                                                                                <th scope="col" class=" table-th ">
                                                                                    Q.{{ $question }}
                                                                                </th>
                                                                            @endforeach
                                                                        ...
                                                                        @if (isset($table['results']))
                                                                            ...
                                                                            @foreach ($table['results'] as $key => $item)
                                                                                <tr>
                                                                                    ...
                                                                                    @for ($i = 1; $i <= 120; $i++)
                                                                                        {{-- {{ dd($item['ocean'][$i - 1]['answer']) }} --}}
                                                                                        <td class="table-td ">
                                                                                            {{-- @if ($item['ocean'][$i - 1]) --}}
                                                                                            {{ $item['ocean'][$i - 1]['answer'] ?? '' }}
                                                                                            {{-- @else
                                                                                            Not Answered
                                                                                        @endif --}}
                                                                                        </td>
                                            ...
                                            <div class="card-body">
                                                <header
                                                    class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                                                    <div class="flex-1">
                                                        <div class="card-title text-slate-900 dark:text-white">RIASEC
                                                        </div>
                                                    </div>
                                                </header>
                                                <div class="badge-group mb-5 w-0">
                                                                    ...
                                                                    <thead class=" bg-slate-200 dark:bg-slate-700">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <th scope="col" colspan="1"
                                                                                class=" table-th bg-danger-400 color-black text-center ">
                                                                                R
                                                                            </th>
                                                                            <th scope="col" colspan="1"
                                                                                class=" table-th bg-danger-400 color-black text-center ">
                                                                        ...
                                                                        @if (isset($table['results']))
                                                                            ...
                                                                            @foreach ($table['results'] as $key => $item)
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="table-td ">
                                                                                        {{ $item['enterprising'] ?? 'N/A' }}
                                                                                    </td>
                                                                                    <td class="table-td ">
                                                                                        {{ $item['conventional'] ?? 'N/A' }}
                                                                                    </td>
                                            ...
                                            <div class="card-body">
                                                <header
                                                    class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                                                    <div class="flex-1">
                                                        <div class="card-title text-slate-900 dark:text-white">English
                                                        </div>
                                                    </div>
                                                </header>
                                                <div class="badge-group">
