                    ...
                    <div class="card">
                        ...
                        <div class="card-body flex flex-col p-6">
                            <header
                                ...
                                <div class="flex-1">
                                    <div class="card-title text-slate-900 dark:text-white">Detailed Reports  <a href="/admin/detailed/report/export/ocean"
                                    ...
                                    <div>
                                     ...
                                     <div class="badge-group mb-5 w-0">
                                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700">
                                            <thead class="">
                                                <tr>
                                                    <th scope="col" class="legend_th table-th border border-slate-600  " style="
                                                    background: white;
                                                    color: black;
                                                ">
                                                        Likert Scale
                                            ...
                                            <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                ...
                                                <tr>
                                                    <td class="legend-title table-th border border-slate-600 dark:bg-slate-800 dark:border-slate-700">+ Keyed</td>
                                                    ...
                                                    <td class="legend-title table-th border border-slate-600 dark:bg-slate-800 dark:border-slate-700">5</td>
                                                    ...
                                                    <table id="students-table"
                                                        ...
                                                        <thead class=" bg-slate-200 dark:bg-slate-700">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th scope="col" colspan="120" class=" table-th bg-primary-400 color-black text-center ">
                                                                    OCEAN
                                                                </th>
                                                            ...
                                                            @if (isset($table['results']))
                                                                ...
                                                                @foreach ($table['results'] as $key => $item)
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-transform: none;" class="table-td ">{{ $item['email'] }} </td>
                                                                        <td class="table-td ">
