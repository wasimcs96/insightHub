    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack container-xxl">
        <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"
            ...
            <h1
                ...
                {{ !empty($business) ? 'Edit Business Unit' : 'Create Business Unit' }}
            </h1>
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item capitalize text-muted">Organization Structure</li>

                <li class="breadcrumb-item"><span class="bullet bg-gray-500 w-5px h-2px"></span></li>

                <!-- Business Unit -->
                <li class="breadcrumb-item capitalize">
                    <a href="{{ route('admin.business.users.index') }}" class="text-muted text-hover-primary">
                        Business Unit
                    </a>
                </li>
                ...
                @if (!empty($business))
                    ...
                    <li class="breadcrumb-item capitalize text-muted">
                        {{-- <a href="{{ route('admin.business.user.edit', $business->id) }}" class="text-muted text-hover-primary"> --}}
                            {{ $business->name }}
                        {{-- </a> --}}
                    </li>
                @endif
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">{{ !empty($business) ? 'Edit Business Unit' : 'Create Business Unit' }}</span>
                </h3>
            </div>
            <div class="card-body">
                <form class="form" action="/admin/business/{{ !empty($business) ? $business->id . '/update' : 'store' }}"
                    ...
                    <div class=" ">
                        {{-- <div class="fv-row mb-7">
                            ...
                            <div class="image-input image-input-outline image-input-placeholder"
                                ...
                                @if (!empty($business)&&isset($business->user->profile_picture)) style="background-image: url('{{ asset($business->user->profile_picture) }}');"
                                @else
                        ...
                        <div class="fv-row mb-7 row">
                            ...
                            <div class="col-lg-6">
                                <label class=" fw-semibold fs-6 mb-2">Business Unit Name</label>
                                <input type="text" name="name"
                                    class="form-control form-control-solid mb-3 mb-lg-0 @error('name') is-invalid @enderror"
                                    placeholder="Enter Business Unit Name" value="{{ !empty($business) ? $business->name : old('name') }}" />
                                @error('name')
                                <div class="invalid-feedback text-red-500">
                                    {{ $message }}
                                </div>
                            ...
                            {{-- <div class="col-lg-4">
                                ...
                                <input type="text" name="first_name"
                                    ...
                                    value="{{ !empty($business) ? $business->user->first_name : old('first_name') }}" placeholder="First Name" />
                                @error('first_name')
                                <div class="invalid-feedback text-red-500">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="text" name="last_name"
                                    ...
                                    placeholder="Last Name" value="{{ !empty($business) ? $business->user->last_name : old('last_name') }}" />
                                @error('last_name')
                                <div class="invalid-feedback text-red-500">
                                    {{ $message }}
                                </div>
                            ...
                            {{-- <div class="col-lg-6">
                                ...
                                <select name="status" class="form-control form-control-solid mb-3 mb-lg-0 @error('status') is-invalid @enderror">
                                    <option value="1" {{ !empty($business) && $business->status == '1' ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ !empty($business) && $business->status == '0' ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('status')
                                <div class="invalid-feedback text-red-500">
                                    {{ $message }}
