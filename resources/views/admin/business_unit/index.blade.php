        ...
        <div class="card">
            ...
            <div class="card-header border-0">
                ...
                <div class="card-title">
                    <h2 class="capitalize"> Business Unit List</h2>
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <a href="/admin/business/create/" class="btn btn-primary d-flex align-items-center">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                    <thead>
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Business Unit Title</th>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex flex-column">
                                    <a class="text-gray-800 text-hover-primary mb-1">{{$business->name ?? ''}}</a>
                            ...
                            {{-- <td>
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input status-toggle" type="checkbox" role="switch" id="flexSwitchCheckChecked_{{ $business && $business->id ? $business->id:'' }}" {{ $business && $business->status == '1' ? 'checked' : '' }} data-id="{{ $business->id }}">
                                </div>
                                @else
                                Inactive
                            ...
                            {{-- <td class="text-center">
                                ...
                                <a href="/admin/business/{{$business->id}}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    <iconify-icon icon="heroicons-outline:pencil-alt" class="fa-1-5"></iconify-icon>
                                </a>
                                <form action="{{ route('admin.business.user.delete', $business->id) }}" id="form-{{ $business->id }}" class="btn btn-icon " method="POST">
                                    @csrf
                                    @method('DELETE')
                                <button type="button" custom1="{{ $business->id }}" class="btn btn-icon btn-bg-light btn-active-color-danger btn-sm show_confirm">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Export Business Unit</h2>
                <!--end::Modal title-->
...
<script>
    $(document).ready(function() {
        $('.status-toggle').change(function() {
            ...
            $.ajax({
                url: '/admin/business/' + divisionId + '/status',
                type: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
                    status: status
