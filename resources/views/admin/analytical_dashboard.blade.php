...
<style>
    ...
    .stage-content {
        ...
        color: #ffffff;
        font-weight: bold;
        font-size: 1.5rem; /* Base font size for funnel */
        box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); /* Subtle shadow */
        transition: transform 0.3s; /* Add a slight transform on hover */
    }
                    ...
                    <div class="px-7 py-5">
                        <form action="{{ url('/admin/analytical/dashboard') }}" method="GET">
                            <div class="mb-10">
                              ...
                              <div>
                                  <select class="form-select form-select-solid" data-close-on-select="false"
                                      ...
                                      <option value="talent_management" class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">
                            ...
                            <div class="mb-10">
                                ...
                                <div>
                                    <select class="form-select form-select-solid" name="department">
                                        <option value="" {{ $departmentId ? '' : 'selected' }}>All Departments</option>
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ url('/admin/analytical/dashboard') }}" class="btn btn-sm btn-light me-2">Reset</a>
            ...
            <div class="funnel">
              @foreach ([
                  ...
                  <div class="stage" style="width: {{ $stage['width'] }};">
                      <div class="stage-content" style="font-size: {{ $stage['font_size'] }}; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
