<div class="sidebar-wrapper group w-0 hidden xl:w-[248px] xl:block">
    ...
    <div class="logo-segment">
        <a class="flex items-center" href="/admin/dashboard">
            @if(session()->get('user') == 'upsi')

            <img src="{{asset('images/upsi-logo.png')}}" width="120px" class="black_logo" alt="logo">
            <img src="{{asset('images/upsi-logo.png')}}" class="white_logo" alt="logo">
            <!-- <span
                class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">Admin</span> -->
            @else
    ...
    <div class="sidebar-menus bg-white dark:bg-slate-800 py-2 px-4 h-[calc(100%-80px)] z-50" id="sidebar_menus">
        <ul class="sidebar-menu">
            ...
            <li class="{{ (request()->is('admin/dashboard')) ? 'active' : '' }}">
                <a href="/admin/dashboard" class="navItem">
            ...
            <li class="{{ (request()->is('admin/analytical')) ? 'active' : '' }}">
                <a href="/admin/analytical" class="navItem">
                    <span class="flex items-center">
                        <iconify-icon class="nav-icon" icon="clarity:analytics-solid-badged"></iconify-icon>
                        <span>Analytical</span>
                    </span>
                </a>
            </li>
            <li class="{{ (request()->is('admin/bookmarks')) ? 'active' : '' }}">
                <a href="/admin/bookmarks" class="navItem">
                    <span class="flex items-center">
            ...
            <li class="{{ (request()->is('admin/potentials')) ? 'active' : '' }}">
                <a href="/admin/potentials" class="navItem">
                    <span class="flex items-center">
            ...
            <li class="{{ (request()->is('admin/detailed/report')) ? 'active' : '' }}">
                <a href="/admin/setting/weightage" class="navItem">
                    <span class="flex items-center">
