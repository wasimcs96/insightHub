                        ...
                        <form action="">
                            <div class="form-group d-flex justify-content-evenly col-lg-12 p-0">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="d-flex">
                                        <select id="type" name="skill_type" class="col-lg-4 form-select rounded-right"
                                        ...
                                        <select id="skill" name="skill" class="form-select col-lg-8 rounded-left"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchSkills(sectorId, trackId, skillType) {
                fetch(`/admin/job-descriptions/view/get-skills-by-sector/${sectorId}/${skillType}`)
                    ...
                    .then(data => {
                        if (data.data) {
                            roleSelect.innerHTML = '<option value="">Select Skill</option>'; // Reset options
                            data.data.forEach(skill => {
                                roleSelect.innerHTML += `<option value="${skill}">${skill}</option>`;
                            });
                        }
                    }).finally(() => {
            ...
            roleSelect.addEventListener('change', function() {
                ...
                if (sectorId && trackId && skillType && skillName) {
                    showOverlay(); 
                    fetch(
                            `/admin/job-descriptions/view/get-skill-details/${sectorId}/${skillName}/${trackId}/${skillType}`
                        )
                        .then(response => response.json())
                        .then(data => {
                            if (data.data) {
