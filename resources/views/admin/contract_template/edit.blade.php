                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" name="name"
                                            ...
                                            placeholder="Template Name" value="{{ old('name', isset($template) ? $template->name : '') }}"/>
                                        @error('name')
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <textarea name="description"
                                            ...
                                            placeholder="Template Description">{{ old('description', isset($template) ? $template->description : '') }}</textarea>
                                        @error('description')
                                        <div class="invalid-feedback text-red-500">
                                            {{ $message }}
                                        </div>
