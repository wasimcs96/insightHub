...
@section('title', 'Create Compensation & Benefits')
    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid position-lg-relative">
        <div id="kt_app_content_container" class="app-container  container-xxl  w-100">
            <div class="justify-content-between align-items-center success-message">
                <p class="fw-medium m-0"><b>Success!</b> Compensation & Benefits template has been created successfully.
                </p>
                <iconify-icon icon="iconamoon:close-bold" width="24" height="24" class="cursor-pointer"
                    id="closeIcon"></iconify-icon>
            </div>

            <h4 class="fw-medium">Create Compensation & Benefits</h4>
            <div class="template-tab">
                <form action="{{ route('admin.talent-acquisition.template-settings.compensation-benefits.store') }}" class="w-100" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label>Compensation & Benefits Name</label>
                        <input name="name" type="text" class="form-control" placeholder="Enter Compensation & Benefits Name">
                    </div>
                    <div class="mb-8">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <!-- Create Button -->
                        <button class="custom-button btn-apply" type="submit">Create Template</button>
                    </div>
                </form>
            </div>
        </div>
