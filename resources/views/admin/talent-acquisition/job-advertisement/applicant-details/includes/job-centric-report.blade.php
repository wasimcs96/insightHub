        ...
        <section class="psychometric-section">
            ...
            <div class="d-flex grid-template mb-9">
                <div class="box w-75 job-centric-sticky h-100">
                    <a href="#skills-alignment"><p class="m-0 fw-medium pb-2">Skills Alignment: Critical Core Skills</p></a>
                    @if (!in_array(env('DB_DATABASE'), config('client.omr_ta_not_required')))
                        <a href="#overall-match-rate"><p class="m-0 fw-medium pb-2">Overall match rate</p></a>
                        <a href="#technical-assessment-result"><p class="m-0 fw-medium pb-2">Technical Assessment Result</p></a>
                    @endif
                    <a href="#behavioral-fit-rate"><p class="m-0 fw-medium pb-2">Behavioral Fit Rate </p></a>
                    <a href="#response-consistency-index"><p class="m-0 fw-medium pb-2">Response Consistency Index </p></a>
                    <a href="#job-match-rate"><p class="m-0 fw-medium pb-2">Job Match Rate</p></a>
                    <a href="#soft-skill-match-rate"><p class="m-0 fw-medium pb-2">Soft Skill Match Rate</p></a>
                    <a href="#personality-type"><p class="m-0 fw-medium pb-2">Personality type</p></a>
                    <a href="#leadership-potential"><p class="m-0 fw-medium pb-2">Leadership Potential</p></a>
                    <a href="#growth-potential"><p class="m-0 fw-medium pb-2">Growth Potential</p></a>
                    <a href="#workplace-alignment-forecast"><p class="m-0 fw-medium pb-2">Workplace Alignment Forecast</p></a>
                    <a href="#flight-risk"><p class="m-0 fw-medium pb-2">Flight Risk</p></a>
                    <a href="#cognitive-test-result"><p class="m-0 fw-medium pb-2">Cognitive Test Result</p></a>
                    <a href="#technical-skill-match-rate"><p class="m-0 fw-medium pb-2">Technical Skill Match Rate</p></a>
                    <a href="#riasec"><p class="m-0 fw-medium pb-2">RIASEC (Top 3)</p></a>
                </div>
