<div class="d-flex applicants-main-div p-0">
    <div class="d-flex justify-content-between">
        <h4 class="m-0">Applications Submitted</h4>
    </div>
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class=" d-flex gap-3 align-items-center w-50 justify-content-end">
            <button id="sendAssessmentLink" class="btn-general d-flex gap-3 align-items-center disabled" disabled>
                <iconify-icon icon="icon-park-outline:send" width="16" height="16"></iconify-icon>
                Send Assessment Link
            </button>
            <button id="rejectCandidateBtnHPApplied" class="btn-reject-candidate d-flex gap-3 align-items-center disabled" disabled>
    ...
    <div>
        {{-- @include('admin.talent-acquisition.job-advertisement.hiring-pipeline.hiring-applied.hiring-applied-table') --}}
    </div>
</div>
