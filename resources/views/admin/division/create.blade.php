    ...
    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex flex-stack container-xxl ">
        <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}"
            ...
            <h1
                ...
                {{ !empty($user) ? 'Edit Division' : 'Create Division' }}
            </h1>
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="/admin/division" class="capitalize text-muted text-hover-primary">
                        {{ isset($user) && !empty($user->head_of_division) ? $user->head_of_division : 'Companies/Divisions' }}
                    </a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-500 w-5px h-2px"></span>
                ...
                <li class="breadcrumb-item text-muted">
                    {{ !empty($user) ? 'Edit Division' : 'Create Division' }} </li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">{{ !empty($user) ? 'Edit Division' : 'Create Division' }}</span>
                </h3>
            </div>
            <div class="card-body">
                <form class="form" action="/admin/division/{{ !empty($user) ? $user->id . '/update' : 'store' }}"
                    ...
                    <div class=" ">
                        ...
                        <div class="fv-row mb-7 row">
                            <div class="col-lg-6">
                                <label class="fw-semibold fs-6 mb-2" for="business_unit_id">Business Unit</label>
                                <select class="form-control form-control-solid mb-3 mb-lg-0 @error('business_unit_id') is-invalid @enderror" name="business_unit_id" id="business_unit_id">
                                    @foreach($businesses as $business)
                                    <option value="{{ $business->id }}" {{ old('business_unit_id', $user->business_unit_id ?? '') == $business->id ? 'selected' : '' }}>
                                        {{ $business->name ?? '' }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-lg-6">
                                <label class=" fw-semibold fs-6 mb-2">Division Name</label>
                                <input type="text" name="head_of_division"
                                    class="form-control form-control-solid mb-3 mb-lg-0 @error('head_of_division') is-invalid @enderror"
                                    placeholder="Enter Division Name" value="{{ !empty($user) ? $user->head_of_division : old('head_of_division') }}" />
