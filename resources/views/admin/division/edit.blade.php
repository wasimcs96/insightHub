...
@section('content')
    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            <form class="form" action="/admin/user/update/{{ $user->id }}" method="POST"
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                @if (isset($user->profile_picture)) style="background-image: url('{{ asset($user->profile_picture) }}');"
                        @else
                        ...
                        <!--begin::Label-->
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <select class="form-select form-select-solid" id="positions" data-control="select2" data-hide-search="true" data-placeholder="Select a Team Member" name="position">
                                    ...
                                    <option value="{{ $user->department_id ?? '' }}" selected>{{ $user->job_position->title ?? 'Select Position' }}</option>
                            ...
                            <div class="d-flex fv-row col-lg-6">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <input class="form-check-input me-3 @error('role_name') is-invalid @enderror"
                                        @if ($user->role_id == 1) checked="checked" @endif name="role_name"
                                        type="radio" value="1" />
                                    <!--end::Input-->
                            ...
                            <div class="d-flex fv-row col-lg-6">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <input class="form-check-input me-3" name="role_name" type="radio" value="2"
                                        @if ($user->role_id == 2) checked="checked" @endif
                            ...
                            <div class="d-flex fv-row col-lg-6">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <input class="form-check-input me-3" name="role_name" type="radio" value="3"
                                        @if ($user->role_id == 3) checked="checked" @endif
                            ...
                            <div class="d-flex fv-row col-lg-6">
                                ...
                                <div class="form-check form-check-custom form-check-solid">
                                    ...
                                    <input class="form-check-input me-3" name="role_name" type="radio" value="4"
                                        @if ($user->role_id == 4) checked="checked" @endif
