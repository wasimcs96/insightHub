                    ...
                    <div class=" ">
                        ...
                        <div class="fv-row mb-7 row">
                            ...
                            <div class="col-md-4 fv-row">
                                ...
                                <option value="{{ $department->id }}" @if(!empty($user) && $user->department_id == $department->id) selected="selected" @endif>{{ $department->head_of_department ?? '' }}</option>
                                @endforeach
                                </select>
                            </div>
                            @else
                            ...
                            @else
                            @php
                            $teams = App\Models\Team::where('department_id',auth()->user()->id)->get();
                            @endphp
