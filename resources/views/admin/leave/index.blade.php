        ...
        <div class="card">
            ...
            <div class="card-header border-0 ">
                ...
                <div class="card-title">
                    <h2 class="capitalize"> Leave List</h2>
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <a href="{{route('leave.create')}}" class="btn btn-primary d-flex align-items-center">
            ...
            <div class="card-body py-4">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5 text-center" id="kt_table_users">
                   ...
                   <th class="min-w-20px text-center">Name</th>
                    <th class="min-w-20px text-center">Days Per Year | Depend on Job</th>
                    {{-- <th class="min-w-20px text-center"></th> --}}

                    {{-- <th class="min-w-20px text-center">Entitlement</th> --}}
                    <th class="min-w-20px text-center">Eligibility</th>
                    <th class="min-w-20px text-center">Purpose</th>
                    <th class="min-w-20px text-center">Cumulative</th>
                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $value->days_per_year != 0 ? $value->days_per_year : 'N/A'}} | {{ $value->depend_on_job == 1 ? 'Yes' : 'No'}} </td>
                            {{-- <td class="text-center">{{ $value->entitlement }}</td> --}}
                            <td class="text-center">  @if($value->eligibility == 'A')
                                All Employee
                            @elseif($value->eligibility == 'M')
                                Male Employee
                            @else
                                Female Employee
                            @endif</td>
                            <td class="text-center">{{ $value->purpose }}</td>
                            <td class="text-center">{{ $value->cumulative ? 'Yes' : 'No' }}</td>
                            <td class="text-center">
                                ...
                                <form action="{{ route('leave.destroy', $value->id) }}" id="form-{{ $value->id }}" class="d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
