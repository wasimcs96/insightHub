        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                ...
                <div class="card-toolbar">
                    <a href="/admin/position/create" class="align-items-center btn btn-light-primary btn-sm d-flex">
                        <iconify-icon icon="icon-park-outline:user-positioning"></iconify-icon> New Position
                    </a>
                </div>
            </div>
            <!--end::Header-->
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-gray-900 text-center fw-bold text-hover-primary d-block mb-1 fs-6">{{ $position->name ?? ''}}</span>

                                </td>
                                <td>

                                    <span class="text-gray-900 text-center fw-bold text-hover-primary d-block mb-1 fs-6">{{ $position->department->name ?? '' }}</span>
                                </td>

                                <td>
                                    <span class="text-gray-900 text-center fw-bold text-hover-primary d-block mb-1 fs-6">{{ $position->level ?? '' }}</span>
                                </td>
                                <td>
                                    <span class="text-gray-900 text-center fw-bold text-hover-primary d-block mb-1 fs-6">
                                        {{ \Carbon\Carbon::parse($position->created_at)->format('j M Y') }}
                                    </span>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="/admin/position/{{ $position->id }}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    ...
                                    <a href="/admin/position/{{ $position->id}}/delete" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
