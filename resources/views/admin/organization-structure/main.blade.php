...
#organizationPositionsChart g {
  transition: transform 0.3s ease-out;
    ...
    cursor: grab;
        ...
        /* Position Level Checkboxes - Exact Figma Style */
.position-level-item .level-checkbox {
    width: 18px;
    height: 18px;
...
.position-level-item .level-checkbox:checked {
    background-color: #F7941C;
    border-color: #F7941C;
}

.position-level-item .level-checkbox:checked::after {
...
.level-13 {
    ...
    <style>
        ...
        .actions {
            /* display: grid; */
            justify-content: space-between;
            grid-template-columns: 49% 0% 51.2%;
            position: relative;
            top: -29px;
        }
...
/* Arrow for tooltip */
.job-position-name:hover::before {
    content: '';
    position: absolute;
    left: 20px;
    top: 100%;
...
/* Alternative: Using Bootstrap tooltip if you're using Bootstrap */
.job-position-tooltip {
    display: block;
    max-width: 100%;
    overflow: hidden;
    text-overflow: ellipsis;
...
.filter-box .apply-filters.disabled {
border: 1px solid #DBDFE9;
background: #F1F1F4;
color: #99A1B7;
pointer-events: none;
...
.options-list .list-item:hover {
    background: #FFF6EA;
}

.options-list .list-item p {
    color: #000;
font-size: 12px;
font-weight: 400;
line-height: 16px;
...
.icons-bg [data-bs-toggle="tooltip"],
.icons-bg iconify-icon {
  pointer-events: none;
}
  ...
  <div class="dropdown-list d-none" id="dropdownList">
    ...
    <div class="dropdown-item">Bentley Cruz</div>
            ...
            <div class="right d-flex gap-3 align-items-center">
                <button id="expand-all-btn" class="expand-all-btn filter-btn">
                    <iconify-icon icon="ri:arrow-down-double-line" width="18" height="18"></iconify-icon> 
                    <span>Expand Org Chart</span>
                </button>

                <button id="collapse-all-btn" class="collapse-all-btn filter-btn" style="display: none">
                    <iconify-icon icon="ri:arrow-up-double-line" width="18" height="18"></iconify-icon> 
                    <span>Collapse Org Chart</span>
                </button>
       ...
       <x-org-structure.details-panel :topPositionCode="$topPositionCode" />
    ...
    <div class="legend-chart elements-chart-inner" id="legendPanel">
        <div class="d-flex align-items-center justify-content-between mb-4 gap-2">
            ...
            <div class="d-flex gap-7">
                ...
                <div class="d-flex flex-column gap-2">
                    ...
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="material-symbols:crown-outline-rounded" style="color: #EB8100;" width="16" height="16"></iconify-icon>
                        <p class="m-0">Top Position</p>
                    </div>
                    {{-- <div class="tags-elements-content d-flex align-items-center gap-3">
                ...
                <div class="d-flex flex-column gap-2">
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="material-symbols-light:target" width="16" height="16"></iconify-icon>
                        <p class="m-0">Overall Match Rate</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="material-symbols-light:psychology-outline-rounded" width="16" height="16"></iconify-icon>
                        <p class="m-0">Behavioral Fit Rate</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="material-symbols-light:work-outline" width="16" height="16"></iconify-icon>
                        <p class="m-0">Job Match Rate</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="material-symbols-light:emoji-objects-outline-rounded" width="16" height="16"></iconify-icon>
                        <p class="m-0">Soft Skill Match Rate</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="carbon:growth" width="16" height="16"></iconify-icon>
                        <p class="m-0">Growth Potential</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="fluent:building-20-regular" width="16" height="16"></iconify-icon>
                        <p class="m-0">Workplace Alignment Forecast</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="carbon:plane" width="16" height="16"></iconify-icon>
                        <p class="m-0">Flight Risk</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="fluent-emoji-high-contrast:brain" width="16" height="16"></iconify-icon>
                        <p class="m-0">Cognitive Ability Test</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="fluent:wrench-settings-20-regular" width="16" height="16"></iconify-icon>
                        <p class="m-0">Technical Skill Match Rate</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon style="color: #78829D;" icon="fluent-mdl2:party-leader" width="16" height="16"></iconify-icon>
                        <p class="m-0">Leadership Potential</p>
                    </div>
                </div>
                <hr style="color: #DBDFE9;">
                <div class="d-flex flex-column gap-2">
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                       <iconify-icon icon="tdesign:forward-filled" class="icon-green rotate-minus-90" width="16" height="16"></iconify-icon>
                        <p class="m-0">Very High</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="mdi:triangle" class="icon-green" width="16" height="16"></iconify-icon>
                        <p class="m-0">High</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="mdi:triangle-down" class="icon-green" width="16" height="16"></iconify-icon>
                        <p class="m-0">Low Risk</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="tdesign:forward-filled" class="icon-green rotate-90" width="16" height="16"></iconify-icon>
                        <p class="m-0">Very Low Risk</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="material-symbols-light:square" class="icon-yellow" width="16" height="16"></iconify-icon>
                        <p class="m-0">Moderate/ Moderate Risk</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="mdi:triangle-down" class="icon-red" width="16" height="16"></iconify-icon>
                        <p class="m-0">Low</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="tdesign:forward-filled" class="icon-red rotate-90" width="16" height="16"></iconify-icon>
                        <p class="m-0">Very Low</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="tdesign:forward-filled" class="icon-red rotate-minus-90" width="16" height="16"></iconify-icon>
                        <p class="m-0">Very High Risk</p>
                    </div>
                    <div class="tags-elements-content d-flex align-items-center gap-3">
                        <iconify-icon icon="mdi:triangle" class="icon-red" width="16" height="16"></iconify-icon>
                        <p class="m-0">High Risk</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasLeft" aria-labelledby="offcanvasLeftLabel">
            ...
            <div class="offcanvas-body">
                ...
                <div class="row" style="justify-content: space-between;">
                    ...
                    <div class="col-5 mt-4">
                        <div class="small-heading">Technical Skill Match Rate</div>
                        <div class="d-flex gap-2 align-items-center">
                            <iconify-icon icon="mdi:square" id="badgeTechnicalSkillMatchRateIcon" class="" width="12" height="12"></iconify-icon>
                            <span id="badge-technical-skill-match">-</span>
                        </div>
                    </div>
                    {{-- <div class="col-5">
                ...
                <div class="mb-4">
                    ...
                    <div class="mb-4">
                        <p class="sub-content">Employee ID</p>
                    ...
                    <div class="mb-4">
                        <div class="sub-content">Leadership Potential</div>
                        <div class="d-flex gap-2 align-items-center">
                            <iconify-icon icon="mdi:square" id="badgeLpIcon" class="" width="12" height="12"></iconify-icon>
                            <p id="badge-lp" class="content-bottom mb-0">-</p>
                        </div>
                    </div>
                ...
                <div class="mb-4">
                        <p class="sub-content">Employee ID</p>
                        <p id="sup-code" class="content-bottom mb-0">-</p>
                </div>
        ...
        <div id="dropdownMenu" class="dropdown-menu dropdown-main text-center">
            <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#assignPosition">Assign
                Employee</button>
            <button class="dropdown-item" id="addPosition">Add Subordinate</button>
...
@section('scripts')
    ...
    const ho = (t, e, n) => {
        ...
        go = (t, e, n, r) => {
            ...
            if (t.parent) {
                const edgeId = `${t.parent}-${t.id}`;
                const edgePath = edgeMap[edgeId];
                
                if (edgePath) {
                    if (n) {
                        edgePath.attr({ stroke: r.edgeColorHover, "stroke-width": r.edgeWidth + 1 });
                        edgePath.front(); // Now you can use front() directly
                    } else {
                        edgePath.attr({ stroke: r.edgeColor, "stroke-width": r.edgeWidth });
                    }
                }
                
                t.parent && go(e[t.parent], e, n, r);
            }
        };
    function yo(t, e, n) {
    ...
    class yh {
        ...
        static drawPath(t, { borderColor: e = po.borderColor, id: n = "",strokeWidth:s=1 } = {}) {
            const r = new Pa({ d: t });
            return r.id(n), r.fill("none").stroke({ color: e, width: s }), r;
        }
    ...
    class vh extends yh {
       ...
       renderEdge(t, layerGroup) {
            ...
            const { nodeHeight, nodeWidth, edgeWidth, edgeColors = {}, parentPortPadding = 16, childPortPadding = 11 } = this.options;
        
            const colors = {
                default: edgeColors.default || '#D3D3D3',
                hover: edgeColors.hover || '#F7941C'
            };
        
            // Anchors with different paddings
            const x1 = parent.x;
            const y1 = parent.y + nodeHeight / 2 + parentPortPadding;
        
            const x2 = child.x;
            const y2 = child.y - nodeHeight / 2 - childPortPadding;
            ...
            // Draw path
            const path = yh.drawPath(pathData, {
                id: `${t.v}-${t.w}`,
            ...
            // Interaction
            path.on('mouseenter', () => {
                path.stroke({ color: colors.hover });
                path.front();
            });
            path.on('mouseleave', () => {
                path.stroke({ color: colors.default });
            });


            edgeMap[`${t.v}-${t.w}`] = path;
  ...
  knob.attr('style', 'cursor:pointer;');
  ...
  const chevron = yh.drawPath(
    ...
    { style: "fill:none; stroke:#FFFFFF; stroke-width:2.2; stroke-linecap:round; stroke-linejoin:round; pointer-events:none;",borderColor:"#FFFFFF" }
  );
  knob.add(chevron);

  // Toggle on click
knob.on("click", function () {
  toggleCollapseById(this.node.dataset.self);
});
...
<script>
    ...
    <script>
        ...
        function loadEmployeeProfile(employeeId) {
            ...
            $jq.ajax({
                ...
                success: function(response) {
                    ...
                    // const badgeTechnicalSkillMatchRate = document.getElementById('badge-technical-skill-match');
                    // badgeTechnicalSkillMatchRate.innerHTML = response.technical_skill_match_rate || '-';
                    // Apply to DOM element
                    const badgeTechnicalSkillMatchRateIcon = document.getElementById('badgeTechnicalSkillMatchRateIcon');
                    badgeTechnicalSkillMatchRateIcon.className = iconColorLevels[response.technical_skill_match_rate_level || 0];
                    badgeTechnicalSkillMatchRateIcon.icon = iconClassLevels[response.technical_skill_match_rate_level || 0];

                    const badgeTechnicalSkillMatchRate = document.getElementById('badge-technical-skill-match');
                    badgeTechnicalSkillMatchRate.innerHTML = response.technical_skill_match_rate || '-';

                    const badgeLeadershipPotential = document.getElementById('badge-lp');
                    badgeLeadershipPotential.innerHTML = response.leadership_potential || '-';
                    // Apply to DOM element
                    const badgeLeadershipPotentialIcon = document.getElementById('badgeLpIcon');
                    badgeLeadershipPotentialIcon.className = iconColorLevels[response.leadership_potential_level || 0];
                    badgeLeadershipPotentialIcon.icon = iconClassLevels[response.leadership_potential_level || 0];
                   ...
                   // Get the container where the strips will be added
                    ...
                    const supCode = document.getElementById('sup-code');
                    supCode.innerHTML = response.superior.employee_code || '-';
        ...
        function fetchData(page = 1) {
            ...
            const url = "{{ url('admin/ajax/organization-chart') }}";
...
const assessmentTypes = [
    { "id": 1, "label": "Overall Match Rate", "icon": "material-symbols-light:target" },
    { "id": 2, "label": "Behavioral Fit Rate", "icon": "material-symbols-light:psychology-outline-rounded" },
    { "id": 3, "label": "Job Match Rate", "icon": "material-symbols-light:work-outline" },
    { "id": 4, "label": "Soft Skill Match Rate", "icon": "material-symbols-light:emoji-objects-outline-rounded" },
    { "id": 5, "label": "Growth Potential", "icon": "carbon:growth" },
    { "id": 6, "label": "Workplace Alignment Forecast", "icon": "fluent:building-20-regular" },
    { "id": 7, "label": "Flight Risk", "icon": "carbon:plane" },
    { "id": 8, "label": "Cognitive Ability Test", "icon": "fluent-emoji-high-contrast:brain" },
    { "id": 9, "label": "Technical Skill Match Rate", "icon": "fluent:wrench-settings-20-regular" },
    { "id": 10, "label": "Leadership Potential", "icon": "fluent-mdl2:party-leader" }

];

const levelTypes = [
    { "id": 1, "label": "Very High", "icon": "tdesign:forward-filled", "iconClass": "bg-green-icon", "assessmentTypeIds": [1, 2, 3, 4, 5,9, 10] },
    { "id": 2, "label": "High", "icon": "mdi:triangle", "iconClass": "bg-green-icon", "assessmentTypeIds": [1, 2, 3, 4, 5, 8,9, 10] },
    { "id": 3, "label": "Moderate", "icon": "material-symbols-light:square", "iconClass": "bg-yellow-icon", "assessmentTypeIds": [1, 2, 3, 4, 5, 8,9, 10] },
    { "id": 4, "label": "Low", "icon": "mdi:triangle-down", "iconClass": "bg-red-icon", "assessmentTypeIds": [1, 2, 3, 4, 5, 8,9, 10] },
    { "id": 5, "label": "Very Low", "icon": "tdesign:forward-filled", "iconClass": "bg-red-icon", "assessmentTypeIds": [1, 2, 3, 4, 5,9, 10] },
    { "id": 6, "label": "Very High Risk", "icon": "tdesign:forward-filled", "iconClass": "bg-red-icon", "assessmentTypeIds": [6, 7] },
    { "id": 7, "label": "High Risk", "icon": "mdi:triangle", "iconClass": "bg-red-icon", "assessmentTypeIds": [6, 7] },
    { "id": 8, "label": "Moderate Risk", "icon": "material-symbols-light:square", "iconClass": "bg-yellow-icon", "assessmentTypeIds": [6, 7] },
    { "id": 9, "label": "Low Risk", "icon": "mdi:triangle-down", "iconClass": "bg-green-icon", "assessmentTypeIds": [6, 7] },
    { "id": 10, "label": "Very Low Risk", "icon": "tdesign:forward-filled", "iconClass": "icon-green ", "assessmentTypeIds": [6, 7] }
];

function generateAssessmentIcon(assessmentDetail) {
    const assessmentType = assessmentTypes.find(type => type.id === assessmentDetail.type_id);
    const levelType = levelTypes.find(level => level.id === assessmentDetail.level_id);
    
    if (!assessmentType || !levelType || !levelType.assessmentTypeIds.includes(assessmentDetail.type_id)) {
        return '';
    }
    
    const tooltipText = assessmentDetail.type_label + ': ' + assessmentDetail.level_label;
    const iconClasses = levelType.iconClass || '';
  ...
  8: 'icon-yellow'
    ...
    var rotateClass = rotateMap[levelType.id] || '';
    
    return '<div class="d-flex align-items-center gap-1 icons-bg ' + iconClasses + '" ' +
           'data-bs-toggle="tooltip" ' +
           'data-bs-placement="top" ' +
           'data-bs-title="' + tooltipText + '">' +
           '<iconify-icon class="' + rotateClass + '" icon="' + levelType.icon + '" width="16" height="16"></iconify-icon>' +
           '<iconify-icon icon="' + assessmentType.icon + '" width="16" height="16"></iconify-icon>' +
           '</div>';
}

function generateAllAssessmentIcons(assessmentDetails) {
    let result = '';
    for (let i = 0; i < assessmentDetails.length; i++) {
        const iconHtml = generateAssessmentIcon(assessmentDetails[i]);
        if (iconHtml !== '') {
            result += iconHtml;
        }
    }
...
const options = {
    ...
    nodeTemplate: (content) => { 
        ...
        var assessmentIconsHTML = '';

        if (requestData.selectedHeadcountCodes.includes(content?.code) && requestData.assessmentFilters != null && isEditMode == false && content?.user_id && requestData.assessment_matches && requestData.assessment_matches.includes(content?.user_id)) {
             

                  const iconsHtml = generateAllAssessmentIcons(requestData.assessmentFilters.assessment_details);
                    assessmentIconsHTML = iconsHtml;
                    const tooltipElements = document.querySelectorAll('[data-bs-toggle="tooltip"]');
                    for (let i = 0; i < tooltipElements.length; i++) {
                        new bootstrap.Tooltip(tooltipElements[i]);
                    }
        }else{
            assessmentIconsHTML = `<div class="tag text-truncate" data-bs-toggle="tooltip" data-bs-placement="top" title="${content?.code}">
                        ${content?.code}
                    </div>`;
        }
...
// NEW: compute collapsed ∪ all descendants(collapsed)
function computeEffectiveCollapsed(mode, baseSet) {
  const idx = (mode === 'edit') ? idxEdit : idxOriginal;
  if (!idx) return baseSet;

  const eff = new Set(baseSet);
  const stack = [...baseSet];
  while (stack.length) {
    const id = stack.pop();
    const kids = idx.childrenOf[id] || [];
...
// REPLACE your buildIndex with this
function buildIndex(root) {
  ...
  (function walk(node, parentId) {
    ...
    const kids = [];
    const pushKid = (c) => { if (c && c.id) { kids.push(c.id); walk(c, node.id); } };

    if (Array.isArray(node.children))        node.children.forEach(pushKid);
    if (Array.isArray(node.hiddenChildren))  node.hiddenChildren.forEach(pushKid);
...
// One in-memory toggle pass → ONE layout + ONE render (no expand-all first)
// REPLACE your applyCollapsedSetToGraph with this version
function applyCollapsedSetToGraph(baseSet) {
  if (!currentGraph || !currentGraph.nodeMap || !currentGraph.data) return;

  const mode = getActiveChartMode();
  const collapsedSet = computeEffectiveCollapsed(mode, baseSet); // <- key change

  const map = currentGraph.nodeMap;

  // Toggle in memory (no intermediate renders)
  for (const id in map) {
    const n = map[id];
    if (!n) continue;
    const collapse = collapsedSet.has(id);
...
// Expand ONLY the path to target; keep sibling branches collapsed (not opened)
// Build a collapsed set that collapses everything except the strict path to target
function buildStrictPathCollapsed(mode, targetId) {
  const idx  = getIndex(mode);
  const root = getRoot(mode);
  if (!idx || !root || !targetId) return new Set();

  // start fully collapsed except root
  const collapsed = new Set(Object.keys(idx.byId).filter(id => id !== root.id));

  // expand only the nodes on the path [root ... target]
  const path = getPathTo(targetId, mode);
  path.forEach(id => collapsed.delete(id));   // expand each ancestor + target

  return collapsed; // siblings of every ancestor remain collapsed because we started 'all collapsed'
}

// Expand ONLY the path to target; keep ALL non-path branches collapsed
async function revealPathAndFocusSingle(nodeIds, { strictReset = false } = {}) {
  const myRev = ++__intentRev;                  // intent guard
  const mode  = getActiveChartMode();
  indexBothCharts();
  ...
  const idx = getIndex(mode);
  if (!idx || !idx.byId[targetId]) return;

  let collapsed = strictReset
    ? buildStrictPathCollapsed(mode, targetId) // recompute from scratch after render
    : new Set(getCollapsedSet(mode));          // tighten current state only (optional path)

  if (!strictReset) {
    // If not rebuilding, tighten so only the strict path opens
    const childrenOf = (parentId) => {
      const p = idx.byId[parentId];
      return []
        .concat(Array.isArray(p?.children) ? p.children : [])
        .concat(Array.isArray(p?.hiddenChildren) ? p.hiddenChildren : []);
    };
    const path = getPathTo(targetId, mode);
    ...
    // collapse siblings of each ancestor (not the next path node)
    for (let k = 0; k < path.length - 1; k++) {
      const A = path[k], next = path[k + 1];
      childrenOf(A).forEach(kid => { if (kid !== next) collapsed.add(kid); });
    }
    // collapse siblings at the target level
    const parent = idx.parentOf[targetId];
    if (parent) childrenOf(parent).forEach(s => { if (s !== targetId) collapsed.add(s); });
  }

  // Apply in ONE render while keeping same zoom/position
  await anchorNodeKeepView(targetId, () => {
    applyCollapsedSetToGraph(collapsed);        // one Dagre layout + render
  });

  if (myRev !== __intentRev) return;            // respect newer intents
  setCollapsedSet(mode, collapsed);             // persist in memory
}
...
async function revealPathAndFocusMultiple(nodeIds) {
  const myRev = ++__intentRev;
  const mode = getActiveChartMode();
  indexBothCharts();
  ...
  const collapsed = getCollapsedSet(mode);         // Get the actual set (not a copy)
  
  // Pick the first target node's root as anchor (usually exists)
  const firstPath = getPathTo(ids[0], mode);
  const anchorId = firstPath && firstPath.length > 0 ? firstPath[0] : ids[0];

  await anchorNodeKeepView(anchorId, () => {
    // Expand all paths
    for (const id of ids) {
      const path = getPathTo(id, mode);
    ...
    applyCollapsedSetToGraph(collapsed);           // ONE layout + ONE render
  });

  // If something newer ran during await, don't overwrite it
  if (myRev !== __intentRev) return;

  setCollapsedSet(mode, collapsed);                // persist
...
// ===== storage namespace per mode+root =====
const ORG_COLLAPSE_NS = 'orgChartCollapsed';
// Invalidate older actions (search reveal vs. manual toggles)
let __intentRev = 0;
...
// Return { set, exists }  → exists=false means no key ever saved.
function loadCollapsedSetFromStorage(mode) {
  ...
  try {
    ...
    return { set: new Set(Array.isArray(arr) ? arr : []), exists: true };
  } catch {
    return { set: new Set(), exists: false };
  }
}
function saveCollapsedSetToStorage(mode, set) {
  try { localStorage.setItem(getStorageKey(mode), JSON.stringify([...set])); } catch {}
}
function clearCollapsedStorage(mode) {
  try { localStorage.removeItem(getStorageKey(mode)); } catch {}
}
...
function collapseAllButRoot(mode) {
  const idx  = (mode === 'edit') ? idxEdit : idxOriginal;
  const root = (mode === 'edit') ? editedOrgChart : originalOrgChart;
  const set  = new Set();
  if (idx && root) {
  ...
  saveCollapsedSetToStorage(mode, set);
  return set;
}

// get → hydrate from storage (respect empty = fully expanded), else default
function getCollapsedSet(mode) {
  if (!collapsedInit[mode]) {
    const { set, exists } = loadCollapsedSetFromStorage(mode);
    if (exists) {
      collapsedState[mode] = set;     // even if size===0 (fully expanded), respect it
    } else {
      collapseAllButRoot(mode);        // first time → default
    }
    collapsedInit[mode] = true;
  }
...
function setCollapsedSet(mode, set) {
  ...
  collapsedState[mode] = s;
  collapsedInit[mode]  = true;
  saveCollapsedSetToStorage(mode, s);
}

// convenience: clear storage + memory and re-init to default (collapse all but root)
function resetCollapsedState(mode) {
  clearCollapsedStorage(mode);
  collapsedInit[mode] = false;
  return getCollapsedSet(mode); // will call collapseAllButRoot and persist
}
function resetAllCollapsedState() {
  resetCollapsedState('original');
  resetCollapsedState('edit');
}



async function toggleCollapseById(nodeId) {
  __intentRev++;                         // cancel any pending reveals
  const myRev = __intentRev;

  const mode      = getActiveChartMode();
  const collapsed = getCollapsedSet(mode);         // storage-backed
  const isCollapsed = collapsed.has(nodeId);

  await anchorNodeKeepView(nodeId, () => {
    if (isCollapsed) collapsed.delete(nodeId);     // expand this node
    else             collapsed.add(nodeId);        // collapse this node
    applyCollapsedSetToGraph(collapsed);           // ONE layout + ONE render (descendant-safe)
  });

  // If something newer ran during await, don't overwrite it
  if (myRev !== __intentRev) return;

  setCollapsedSet(mode, collapsed);                // persist (memory + localStorage)
  adjustMaxWidthToContent('.text-truncate');
}

function clearAllCollapseKeys() {
  // remove any key we created for collapse state
  for (let i = localStorage.length - 1; i >= 0; i--) {
    const k = localStorage.key(i);
    if (k && k.startsWith('orgChartCollapsed:')) localStorage.removeItem(k);
  }
  // reset in-memory caches so first render re-inits to default
  collapsedState.original = new Set();
  collapsedState.edit     = new Set();
  collapsedInit.original  = false;
  collapsedInit.edit      = false;
}



// Clear all persisted collapse states if this page load is a RELOAD
(function clearCollapseOnReload() {
  const nav = performance.getEntriesByType('navigation')[0];
  const isReload = nav ? nav.type === 'reload'
                       : (performance.navigation && performance.navigation.type === 1); // fallback

  if (isReload) clearAllCollapseKeys(); // defined below
...
function renderOrgChart(data) {
  ...
  // Create tree with panZoom disabled
  const modifiedOptions = {
    ...options,
    enablePanZoom: false,  // Disable default pan/zoom
    highlightOnHover:true
  };
  
  const tree = new ApexTree(container, modifiedOptions);
  const graph = tree.render(data);

  graph.fitScreen = function() {};   // no auto-fit on re-renders
  currentGraph = graph;
  window.__apexGraph = graph;  // Also set for scroll handler

  // Disable default panZoom after render
  if (graph.canvas && graph.canvas.panZoom) {
    setTimeout(() => {
      try {
        graph.canvas.panZoom(false);
      } catch(e) {}
    }, 100);
  }
  ...
  // Initialize custom scroll behavior after render tasks
  setTimeout(() => {
    initializeCustomScrollBehavior();
     adjustMaxWidthToContent('.text-truncate');
  }, 600);
  adjustMaxWidthToContent('.text-truncate');
  ...
  if (requestData.headcountCode != null) {
    setTimeout(() => {
        ...
        showOverlay();
        revealPathAndFocusSingle([requestData.headcountCode], { strictReset: true });
    },1000);
...
function initializeCustomScrollBehavior() {
  const container = document.getElementById('organizationPositionsChart');
  const svg = container?.querySelector('svg');
  if (!svg) return;

  // Disable library's wheel handlers
  if (window.__apexGraph && window.__apexGraph.canvas) {
    const svgjs = window.__apexGraph.canvas;
    if (svgjs.off) {
      svgjs.off('wheel');
      svgjs.off('mousewheel');
      svgjs.off('DOMMouseScroll');
    }
  }

  // Remove existing wheel listeners
  svg.onwheel = null;
  svg.onmousewheel = null;
  ...
  svg.addEventListener('wheel', function(e) {
    ...
    const graph = window.__apexGraph;
    if (!graph) return;
    ...
    if (e.ctrlKey || e.metaKey) {
      ...
      const svgX = vbX + (mouseX / rect.width) * vbWidth;
      const svgY = vbY + (mouseY / rect.height) * vbHeight;
      
      const newWidth = vbWidth * zoomFactor;
      const newHeight = vbHeight * zoomFactor;
      
      const newX = svgX - (mouseX / rect.width) * newWidth;
      const newY = svgY - (mouseY / rect.height) * newHeight;
      
      if (newWidth > 100 && newWidth < 10000) {
        graph.updateViewBox(newX, newY, newWidth, newHeight);
      }
      
    } else if (e.shiftKey) {
      // Shift + Scroll = Horizontal pan (FIXED)
      // When shift is held, deltaY becomes the horizontal movement
      const horizontalDelta = deltaY !== 0 ? deltaY : deltaX;
      
      if (horizontalDelta < 0) {  // FIXED: Reversed the logic
        // Scroll up or left = move left
        graph.updateViewBox(vbX - scrollAmount, vbY, vbWidth, vbHeight);
      } else if (horizontalDelta > 0) {
        // Scroll down or right = move right  
        graph.updateViewBox(vbX + scrollAmount, vbY, vbWidth, vbHeight);
      }
      
    } else {
      // Regular Scroll = Vertical pan only
      if (deltaY > 0) {
        graph.updateViewBox(vbX, vbY + scrollAmount, vbWidth, vbHeight);
      } else if (deltaY < 0) {
        graph.updateViewBox(vbX, vbY - scrollAmount, vbWidth, vbHeight);
      }
    }
  ...
  svg.addEventListener('mousedown', function(e) {
    // Only start drag with left mouse button and no modifier keys
    if (e.button === 0 && !e.ctrlKey && !e.shiftKey && !e.altKey) {
      // Don't start drag if clicking on interactive elements
      if (e.target.closest('g[data-expanded]') || 
  ...
  svg.addEventListener('mousemove', function(e) {
    ...
    // Update viewBox (subtract because we're moving the viewport)
    graph.updateViewBox(
      startViewBoxX - svgDx,
      startViewBoxY - svgDy,
      viewBox.width,
  ...
  // Handle mouseup on window to catch when mouse leaves SVG
...
async function init() {
  await fetchData(); // wait until data is ready
  var topCode1 = "{{ $topPositionCode }}";
  if (topCode1) {
    zoomToNode(topCode1);
  }
}
...
init();
    ...
    <script>
        ...
        async function handleAddPositionSubmit(modalEl) {
            ...
            if (addChildNode(editedOrgChart, parentId, newNode)) {
                ...
                revealPathAndFocusSingle([headcountCode], { strictReset: true });
        ...
        function transferEmployeeNode(tree, fromHeadcount, toHeadcount, reasonForTransfer = '') {
                ...
                if (!fromNode || !fromNode.data || !fromNode.data.user_id) return false;

                const { user_id: uid, name } = fromNode.data;

                // remove from source
                if (!removeEmployeeNode(tree, fromHeadcount)) return false;

                // assign to destination
                if (!assignEmployeeNode(tree, toHeadcount, uid, name)) {
                    // rollback
                ...
                // mark reasons safely
                fromNode.reasons = fromNode.reasons || {};
                fromNode.reasons.move_employee = reasonForTransfer || '';

                const destNode = findNode(tree, toHeadcount);
                if (destNode) {
                    destNode.data.is_transfer = true;
                    destNode.reasons = destNode.reasons || {};
                    destNode.reasons.move_employee = reasonForTransfer || '';

                    // change log (your existing deep copies)
                    const deepFrom = { ...JSON.parse(JSON.stringify(fromNode)), children: [] };
                    const deepDest = { ...JSON.parse(JSON.stringify(destNode)), children: [] };
                    pushModifiedNode(deepFrom);
                    pushModifiedNode(deepDest);
                }
    ...
    <script>
        ...
        function toggleEditUI(enable) {
            ...
            // Keep client-side StateManager in sync if the orgChartFilter bootstrap is present
            try {
                if (window.orgChartFilter && window.orgChartFilter.stateManager && typeof window.orgChartFilter.stateManager.update === 'function') {
                    window.orgChartFilter.stateManager.update('isEditMode', isEditMode);
                }
            } catch (err) {
                // ignore
            }

            // If enabling edit mode, clear all filters from the frontend (and apply)
            try {
                if (isEditMode && window.orgChartFilter && window.orgChartFilter.filterManager && typeof window.orgChartFilter.filterManager.clearAll === 'function') {
                    // Clear filters to present a clean edit workspace
                    window.orgChartFilter.filterManager.clearAll();
                }
            } catch (err) {
                // ignore
            }

            // Show/hide assessment block in the filters pane when edit mode changes
            try {
                const assessmentBlock = document.querySelector('[data-key="assessment"]');
                if (assessmentBlock) {
                    if (isEditMode) {
                        assessmentBlock.classList.add('d-none');
                        assessmentBlock.setAttribute('hidden', 'true');
                    } else {
                        assessmentBlock.classList.remove('d-none');
                        assessmentBlock.removeAttribute('hidden');
                    }
                }
            } catch (err) {
                // ignore
            ...
            // Dispatch event so frontend listeners (AssessmentFilter, etc.) can react
            try {
                window.dispatchEvent(new CustomEvent('isEditModeUpdated', { detail: { isEditMode } }));
            } catch (err) {
                // ignore
            }
        }
                ...
                ModalManager.open({
                    ...
                    async onSubmit(modalEl) {
                        ...
                        if (!message) {
                            ...
                            await transferEmployeeNode(editedOrgChart, code, jobPositionField.value, reason);
                            await renderOrgChart(editedOrgChart);
                            await revealPathAndFocusSingle(jobPositionField.value);
...
document.getElementById('expand-all-btn').addEventListener('click', () => {
  showOverlay();
  const mode = getActiveChartMode();
  const collapsed = new Set(); // clear the collapsed set (expand everything)

  
  // Apply expanded state to graph
  setCollapsedSet(mode, collapsed);
  applyCollapsedSetToGraph(collapsed);

  
  // Show the Collapse button after expand
  document.getElementById('expand-all-btn').style.display = 'none';
  document.getElementById('collapse-all-btn').style.display = 'flex';

  // Trigger a re-render or animation to reflect the expanded state
...
document.getElementById('collapse-all-btn').addEventListener('click', () => {
  ...
  // Collapsing all nodes except the root node (this keeps the root node expanded)
  Object.keys(idx.byId).forEach(id => {
    if (id !== root.id) collapsed.add(id); // Exclude the root node
  });

  // Apply collapsed state to graph
  setCollapsedSet(mode, collapsed);
  applyCollapsedSetToGraph(collapsed);

  // Show the Expand button after collapse
  document.getElementById('expand-all-btn').style.display = 'flex';
  document.getElementById('collapse-all-btn').style.display = 'none';

  // Trigger re-render to reflect the collapsed state
  setTimeout(() => {
    schedulePostRenderTasks();
                    var topCode = "{{ $topPositionCode }}";
                    if (topCode != null) {
